`timescale 1ns/1ps
// ot_rom_8192x104_m8: ASAP7 via-programmed NOR mask ROM 8192 x 104, mux 8; layout and timing content-independent; OpenTallas tools/mem_compiler/rom_gen.py v1.0
// verilator lint_off BLKSEQ
// verilator lint_off WIDTH
// verilator lint_off UNUSED
module ot_rom_8192x104_m8 #(parameter string VIAMAP = "", parameter string INSTANCE = "") (
    input  wire clk,
    input  wire ce_in,
    input  wire [12:0] addr_in,
    output reg  [103:0] rd_out
);
    localparam integer WORDS = 8192;
    localparam integer BITS = 104;
