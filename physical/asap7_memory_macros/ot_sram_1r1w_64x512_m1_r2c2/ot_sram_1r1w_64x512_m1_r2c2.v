...
module ot_sram_1r1w_64x512_m1_r2c2 (
    ...
    localparam integer BITS = 512;
    localparam integer MUX = 1;
    localparam integer AW = 6;
    localparam integer ROWS = 64;
    localparam integer NSR = 2;
    localparam integer NSC = 2;
    localparam integer PR = 66;
    localparam integer PC = 514;
    localparam integer RA = 6;
...
`endif
    ...
    // read-before-write: a same-address read in the write cycle returns the old word
