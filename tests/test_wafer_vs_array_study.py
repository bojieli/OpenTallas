...
def test_sinkhorn_knobs(env):
    ...
    def sk(**kw):
        # the knobs are pipelined-step what-ifs (the model's default takes the faster of the pipelined
        # fadd/fdiv and the routed ot_hdc_sinkhorn unit); the study prices them on the pipelined datapath
        kw.setdefault("sinkhorn_impl", "pipelined")
