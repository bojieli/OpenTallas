...
def test_future_cursor(tmp_path, interleave):
...
.cfg_rows_per_scale_a(16'd2),.cfg_scale_stride_a(16'd4),.cfg_scale_stride_b(16'd3),
.cfg_groups_per_scale_a(16'd3),.cfg_groups_per_scale_b(16'd4),
.cfg_a_base(cfg_a_base),.cfg_s_base(32'd200),.cfg_ws_base(32'd300),.cfg_w_base(32'd400),
