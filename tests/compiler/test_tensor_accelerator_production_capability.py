...
def test_v24_capability_adds_bounded_residual_and_silu_without_timing_claims() -> None:
    capability = load_production_capability(CAPABILITY_V5_PATH)
    assert (capability.command_abi_major, capability.command_abi_minor) == (2, 4)
    assert capability.qualified_execution_modes == (
        "bf16_tensor",
        "transactional_state",
        "vector_fp32",
