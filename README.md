...
| OpenTallas redesigned ROM array, DeepSeek-V4.1-Flash, 200K context | **15,556 tokens/s per user** at batch 1; **12,208** with 64 concurrent users | Deterministic analytical result on the [analytical report](docs/ANALYTICAL_REPORT.md) framework; not measured silicon | <!-- figure: 15,556 src="results/roofline/candidates/deepseek-v41-flash/n5_vs_b200/analytical.json#comparisons[rom_design=DeepSeek-V4.1-Flash/ROM-N5-native-HBMKV-array-hw-hybrid-x188,batch_size=1].rom_per_user_tokens_s" name="README V4.1 ROM batch-1 rate" --> <!-- figure: 12,208 src="results/roofline/candidates/deepseek-v41-flash/n5_vs_b200/analytical.json#comparisons[rom_design=DeepSeek-V4.1-Flash/ROM-N5-native-HBMKV-array-hw-hybrid-x188,batch_size=64].rom_per_user_tokens_s" name="README V4.1 ROM batch-64 rate" -->
| Same ROM array versus B200 on NVLink/NVL72 at the same silicon | **3.87×** per user at batch 1, **8.52×** at 64 users | Modeled; the GPU picks its own best layout, including NVL72 and expert parallelism | <!-- figure: 3.87 src="results/roofline/candidates/deepseek-v41-flash/n5_vs_b200/analytical.json#comparisons[rom_design=DeepSeek-V4.1-Flash/ROM-N5-native-HBMKV-array-hw-hybrid-x188,batch_size=1].per_user_speed_ratio" name="README V4.1 batch-1 ratio" --> <!-- figure: 8.52 src="results/roofline/candidates/deepseek-v41-flash/n5_vs_b200/analytical.json#comparisons[rom_design=DeepSeek-V4.1-Flash/ROM-N5-native-HBMKV-array-hw-hybrid-x188,batch_size=64].per_user_speed_ratio" name="README V4.1 batch-64 ratio" -->
| Each side at its best | **3.18×** throughput, **3.97×** tokens per joule | Best design and batch on each side at the same silicon | <!-- figure: 3.18 src="results/roofline/candidates/deepseek-v41-flash/n5_vs_b200/analytical.json#capacity_comparison[model=DeepSeek-V4.1-Flash,silicon_area_mm2=554700.0].aggregate_ratio" name="README V4.1 best throughput ratio" --> <!-- figure: 3.97 src="results/roofline/candidates/deepseek-v41-flash/n5_vs_b200/analytical.json#capacity_comparison[model=DeepSeek-V4.1-Flash,silicon_area_mm2=60300.0].tokens_per_joule_ratio" name="README V4.1 best energy ratio" -->
