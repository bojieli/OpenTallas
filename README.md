...
> target-format reference. Twenty-two of 43 graph operator kinds have
> unit-qualified executable references; the other 21 references and all service-engine/RTL
