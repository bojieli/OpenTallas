...
> target-format reference. Twenty-four of 43 graph operator kinds have
> unit-qualified executable references; the other 19 references and all service-engine/RTL
