...
states**, graph `fa785d3fd7e3…`. **`build/` is not committed**, so <!-- figure: "fa785d3fd7e3…" src="results/abi3/program_status.json#neutral_ir.deepseek-v4-flash-0731.graph_id" name="DeepSeek IR graph id" -->
...
them. The DeepSeek row moved twice while the previous version of this paragraph
stood — `3,003 / 71,278 / 572431f15e65`, then `3,976 / 7,066 / e9b960ffcb19` —
and nothing noticed either time until a figure checker was pointed at it.
