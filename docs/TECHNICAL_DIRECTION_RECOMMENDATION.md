...
|---|---|---:|---:|---:|---:|---|---:|
| Qwen3-8B @8K | **6 × 815 mm² reticle dies**, SRAM KV, pipeline | 4,890 | 3,110.4 | 636.1 | 1 | 6 × A100 | 6.29× | <!-- figure: 4,890 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.silicon_area_mm2" name="headline Qwen area" --> <!-- figure: 3,110.4 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.per_user_tokens_s" name="headline Qwen per-user rate" --> <!-- figure: 636.1 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.tokens_s_per_1000mm2" name="headline Qwen density" --> <!-- figure: 6.29 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.per_user_speed_ratio" name="headline Qwen iso-area ratio" -->
...
**387 of 9,306 feasible points (4.2%) are power-limited.** All 387 are in the
N5/B200 study; none in N6/A100. The worst is throttled 1.53×: a sixteen-chip,
13,040 mm² Qwen HBM-KV array at batch 256 falls from 208.2 to 136.6 tok/s per user.
...
- **It survives for ROM wafers, not for the whole wafer class.** The throttled
  ...
  point of either family is throttled. **No wafer-scale ROM design is throttled, and no wafer-scale
...
|---|---|---:|---:|
| N6 vs A100 | Qwen3-8B (dense) | 13.8× | **3.9×** | <!-- figure: 3.9 src="results/roofline/n6_vs_a100/analytical.json#power_and_energy.energy_per_token[model=Qwen3-8B,batch_size=256].tokens_per_joule_advantage_x" name="Qwen3-8B tokens/joule advantage at batch 256, N6" -->
...
|---|---|---:|---:|---:|---:|---:|---|
| Qwen3-8B @8K | `…SRAMKV-array-pipeline-x6` | **4,890** | 6 × 815 mm² | 3,110.4 | **636.1** | 1 | `weight_read` | <!-- figure: 4,890 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.silicon_area_mm2" name="Qwen recommended area, N6" --> <!-- figure: 3,110.4 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.per_user_tokens_s" name="Qwen recommended per-user rate, N6" --> <!-- figure: 636.1 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.tokens_s_per_1000mm2" name="Qwen recommended throughput density, N6" -->
...
|---|---:|---|---:|---:|---:|---:|---:|---:|
| Qwen3-8B | 4,890 | 6 × A100, tensor | 4,956 | 3,110.4 | 494.8 | **6.29×** | 1 | 344 | <!-- figure: 4,956 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.iso_area_gpu_silicon_area_mm2" name="Qwen iso-area GPU silicon, N6" --> <!-- figure: 494.8 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.iso_area_gpu_per_user_tokens_s" name="Qwen iso-area GPU rate, N6" --> <!-- figure: 6.29 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.per_user_speed_ratio" name="Qwen recommended-design iso-area ratio, N6" --> <!-- figure: 344 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.iso_area_gpu_max_resident_users" name="Qwen iso-area GPU resident sessions, N6" -->
...
|---|---|---|---|---|
| Qwen3-8B | array ×6, SRAM KV, 4,890 mm², **1 session** | array ×5, HBM KV, tensor, 4,075 mm², 298 sessions | array ×5, HBM KV, pipeline, 4,075 mm², 298 sessions | same array ×5 pipeline |
...
|---|---|---|---:|---:|---:|---|---:|---:|
| N6/A100 | PRIMARY, BF16 | array ×6 | 4,890 | 3,110.4 | 636.1 | 6 × A100 | 494.8 | **6.29×** | <!-- figure: 3,110.4 src="results/roofline/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.per_user_tokens_s" name="Qwen primary per-user rate, N6" -->
| N6/A100 | variant, 4.25 b | array ×3 | 2,445 | 9,106.2 | 3,226.6 | 3 × A100 | 701.2 | 12.99× | <!-- figure: 2,445 src="results/roofline/quantised_variant/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.silicon_area_mm2" name="Qwen variant area, N6" --> <!-- figure: 9,106.2 src="results/roofline/quantised_variant/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.per_user_tokens_s" name="Qwen variant per-user rate, N6" --> <!-- figure: 12.99 src="results/roofline/quantised_variant/n6_vs_a100/analytical.json#design_selection.models[model=Qwen3-8B].recommended.per_user_speed_ratio" name="Qwen variant iso-area ratio, N6" -->
