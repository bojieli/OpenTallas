...
| SRC-DSV4-FLASH-CONVERT | [DeepSeek-V4-Flash-0731 checkpoint conversion](https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash-0731/blob/7872f01b1d1fe23eabc4c98b48bffcef5a386062/inference/convert.py) | same revision; local SHA-256 `6efe65ebc66b18c9f2656816608f941cacfe20da79c2dee19040ecbee8b42bfe` | Official E2M1 lookup values and low-nibble-then-high-nibble unpack order used by the independent numeric reference and canonical-layout contract. |
