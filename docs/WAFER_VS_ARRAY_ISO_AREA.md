...
The wafer reaches the array's batch-1 rate only when a designed express fabric brings the field crossing down to between 8.0 and 22.5 ns, depending on size and divider. That is against the array at its point link latencies. Against the array's own fast band end it needs 3.7 to 10.3 ns, which in the worst case is below the wire-plus-router limit of 5.25 ns. <!-- figure: 8.0 src="results/roofline/critical_path/wafer_vs_array_iso_area.json#summary.extremes.crossover_ns_vs_point_min" --> <!-- figure: 22.5 src="results/roofline/critical_path/wafer_vs_array_iso_area.json#summary.extremes.crossover_ns_vs_point_max" --> <!-- figure: 3.7 src="results/roofline/critical_path/wafer_vs_array_iso_area.json#summary.extremes.crossover_ns_vs_low_min" --> <!-- figure: 10.3 src="results/roofline/critical_path/wafer_vs_array_iso_area.json#summary.extremes.crossover_ns_vs_low_max" -->
...
At batch 64 the wafer is slower at 3, 4 and 12 wafers in every fabric variant. The per-user ratio spans 0.40 to 1.12. <!-- figure: 0.40 src="results/roofline/critical_path/wafer_vs_array_iso_area.json#summary.extremes.ratio_b64_min" --> <!-- figure: 1.12 src="results/roofline/critical_path/wafer_vs_array_iso_area.json#summary.extremes.ratio_b64_max" -->
...
|---|---|---|---|---|---|---|---|---|---|
| 2 | 3,487 | 4,196 | 0.83 | 1.05 | 128,443 | 107,452 | 1.20 | 1.39 / 1.18 | 16.1 / 12.0 | <!-- figure: 0.83 src="results/roofline/critical_path/wafer_vs_array_iso_area.json#summary.cells[id=W2.fdiv31_built.mesh_125].ratio_b1" -->
