...
- [x] W4.7 DeepSeek exact-32-node sharded deployment —
  ...
  plus independent checker admit **1,286** instructions and **3,305** descriptors <!-- figure: 1286 src="results/abi3/hbm_deepseek_deployment_certificate.json#cases[case=deepseek-v4-flash-hbm-cluster].actual.instructions" name="DeepSeek HBM instructions, W4.7" --> <!-- figure: 3305 src="results/abi3/hbm_deepseek_deployment_certificate.json#cases[case=deepseek-v4-flash-hbm-cluster].actual.descriptors" name="DeepSeek HBM descriptors, W4.7" -->,
...
- [x] W5.6 DeepSeek 32-node reticle-class ROM **array** (TA-DS-ROM-ARRAY-FLASH,
  ...
  **3,159** descriptors <!-- figure: 3,159 src="results/abi3/rom_schedule_checks.json#cases[case=deepseek-v4-flash-rom-array-32].actual.descriptors" name="array ROM descriptors, W5.6" -->,
...
- [~] W11.3 Evidence ledger: every number traced to executed counters or labeled
  ...
  **3,294** candidates remain explicitly `untriaged`. <!-- figure: 3294 src="results/abi3/prose_figure_coverage.json#totals.unbound_triage.untriaged" name="W11.3 candidates still awaiting triage" -->
