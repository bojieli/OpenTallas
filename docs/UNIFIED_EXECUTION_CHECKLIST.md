...
- [~] W11.3 Evidence ledger: every number traced to executed counters or labeled
  ...
  **2,282** candidates remain explicitly `untriaged`. <!-- figure: 2282 src="results/abi3/prose_figure_coverage.json#totals.unbound_triage.untriaged" name="W11.3 candidates still awaiting triage" -->
