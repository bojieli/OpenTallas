...
- [ ] W13.4 DeepSeek-V4-Flash **ROM** (wafer) — **zero tokens.** Nine blockers
  ...
  128, and [OI-39] names `ATTENTION.SPARSE`'s scalar reference as the standing
