...
- [~] W11.3 Evidence ledger: every number traced to executed counters or labeled
  ...
  **3,205** candidates remain explicitly `untriaged`. <!-- figure: 3205 src="results/abi3/prose_figure_coverage.json#totals.unbound_triage.untriaged" name="W11.3 candidates still awaiting triage" -->
