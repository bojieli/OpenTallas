...
| M4 | Artifact-only fixed-microcode service paths execute official lookup tensors and all 1,024 Query-A FP8 output rows. The real chain is now verified official HC_PRE result `666195999dc403c746cae6f2db12ea27b99774b6c8747c043732e98e8e3f0280` → independently verified Query-A request `fb3e4c72fb690b05671de948b9d3ea6096f7174ed09b48c583203a41995f113f` → artifact-only Query-A result manifest `d30df5494e60c3f261cc6bec15320680ee3e87d867873e1d0fc100f7776336c0`; runtime and checker reject artifact mutation, result drift, and coverage overstatement | Partial: this proves only the complete Query-A fragment, not attention, a transformer block, transactional KV execution, complete graph-to-microcode lowering, or full-model execution |
| M5 | No certified physical schedule exists | Open |
| M6 | Official lookup differential `830f0d8a0730d012e6be41eb1507f10ef1b70f1829efbbad7b3e50cd2b3e2a95`, selected-row FP8 differential `9b4cacd415df0fbd77b08c24bbb4b48b737f0b3305abfd08ba719d4302e3b800`, and complete-output FP8 differential `f8d95b84c683b9772755b6146da0af84955987e19e0ea05fe4a5ad05c7f0c499` are exact | Partial: these isolated operators are not a checkpoint-derived layer or all layer classes |
