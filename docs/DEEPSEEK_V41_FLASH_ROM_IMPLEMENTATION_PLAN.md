...
1. **The packaged array holds its per-user rate as users are added.** With
   ...
   N5 array serves 5,218 <!-- figure: 5,218 src="results/roofline/candidates/deepseek-v41-flash/n5_vs_b200/analytical.json#comparisons[rom_design=DeepSeek-V4.1-Flash/ROM-N5-native-HBMKV-array-hw-hybrid-x176,batch_size=1].rom_per_user_tokens_s" name="V4.1 array rate B1" -->
   ...
   hyper-connection Sinkhorn chains dominate it). V4-Flash goes from 4,202 <!-- figure: 4,202 src="results/roofline/n5_vs_b200/analytical.json#comparisons[rom_design=DSV4-Flash/ROM-N5-native-SRAMKV-array-hw-hybrid-x56,batch_size=1].rom_per_user_tokens_s" name="V4-Flash array rate B1" -->
   to 2,465 <!-- figure: 2,465 src="results/roofline/n5_vs_b200/analytical.json#comparisons[rom_design=DSV4-Flash/ROM-N5-native-HBMKV-array-hw-pipeline-x56,batch_size=64].rom_per_user_tokens_s" name="V4-Flash array rate B64" -->,
