...
| Scan-off equivalence proven | KV streamer, matrix engine (stream unit pending) | matrix engine (stream unit pending) | package controller, fabric router; argmax, multicast, MoE-dispatch and expert-port collectives |
