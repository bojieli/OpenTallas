...
|---|---|---|---|
| Qwen3-8B | array ×7, SRAM KV, 5,705 mm², **1 session** | batch 2 → array ×5, HBM KV, 4,075 mm², 298 sessions | batch 4–256 → array ×5 pipeline |
