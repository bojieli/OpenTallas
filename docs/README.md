...
| See every target at a glance | [Architecture atlas](ARCHITECTURE_ATLAS.html) (open in a browser): diagrams of the decode core, Qwen3-8B reticle, ROM array, ROM wafer, DeepSeek-V4.1 package and HBM machine, and the ROM-vs-HBM comparisons | [token pipeline plan](TOKEN_PIPELINE_OPTIMIZATION_PLAN.md) and the [analytical report](ANALYTICAL_REPORT.md) |
