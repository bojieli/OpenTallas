...
| per-MAC period | — | **executed after item 11 (`2f6b0a4`): 6.0 ns closed with zero slew/cap/fanout violations, 5.01 ns at post-route fmax 199.7 MHz, search minimum 4.32 ns** vs baseline 104.1 ns (`results/physical_abi3/asap7/matmul_bf16_sram_engine/pnr.json`) — 17.4x at the closed target. Before item 11: 14.95 ns at 66.9 MHz, 8.5 ns not closed; the 4.4 ns prediction was wrong by 3.4x and the reason was the §4.2 divider path, now gone from the timing report | **executed after item 11: 46 ns closed clean (+10.8 ns slack), 35.2 ns at post-route fmax 28.4 MHz, search minimum 41.6 ns**. Before item 11: 96.7 ns post-route, 28 ns not closed; the 28 ns prediction assumed the adder was the limiter, and after the divider left it is |
| per-MAC area | — | **executed after item 11: 3,790 µm² routed at 0.37 utilisation, 32,909 cells** vs baseline 48,274 µm² per MAC/cycle (12.7x better); before item 11 6,849 µm² and 65,384 cells; the ~1,370 µm² prediction was wrong by 2.8x | **executed after item 11: 243,582 µm², 35,724 cells**; before 486,077 µm² and 70,871 cells (no sky130hd baseline for the matmul engine exists; recorded, not compared) |
