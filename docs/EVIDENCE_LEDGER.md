...
It leaves **2,238** explicitly untriaged. <!-- figure: 2238 src="results/abi3/prose_figure_coverage.json#totals.unbound_triage.untriaged" name="prose candidates still awaiting triage" -->
