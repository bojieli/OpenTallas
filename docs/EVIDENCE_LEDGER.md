...
It leaves **2,872** explicitly untriaged. <!-- figure: 2872 src="results/abi3/prose_figure_coverage.json#totals.unbound_triage.untriaged" name="prose candidates still awaiting triage" -->
