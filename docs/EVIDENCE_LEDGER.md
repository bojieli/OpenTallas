...
It leaves **2,299** explicitly untriaged. <!-- figure: 2299 src="results/abi3/prose_figure_coverage.json#totals.unbound_triage.untriaged" name="prose candidates still awaiting triage" -->
