...
It leaves **2,230** explicitly untriaged. <!-- figure: 2230 src="results/abi3/prose_figure_coverage.json#totals.unbound_triage.untriaged" name="prose candidates still awaiting triage" -->
