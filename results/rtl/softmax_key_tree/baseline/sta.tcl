...
read_verilog /home/ubuntu/OpenTallas/build/softmax_key_tree_baseline_synth/mapped.v
link_design ot_a3_attention_softmax_block
source /home/ubuntu/OpenTallas/build/softmax_key_tree_baseline_synth/constraint.sdc
...
report_checks -path_delay max -digits 4 -group_count 1 > /home/ubuntu/OpenTallas/build/softmax_key_tree_baseline_synth/setup_path.rpt
report_checks -path_delay min -digits 4 -group_count 1 > /home/ubuntu/OpenTallas/build/softmax_key_tree_baseline_synth/hold_path.rpt
exit
