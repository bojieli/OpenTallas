export DESIGN_NICKNAME = opentallas_ot_hdc_fp32_mul_pipe_asap7
export DESIGN_NAME = ot_hdc_fp32_mul_pipe
export PLATFORM = asap7
export VERILOG_FILES = /src/rtl/hdc/ot_hdc_fp32_mul_pipe.sv
