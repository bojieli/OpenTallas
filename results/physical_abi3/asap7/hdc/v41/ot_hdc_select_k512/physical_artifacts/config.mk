export DESIGN_NICKNAME = opentallas_ot_hdc_select_asap7
export DESIGN_NAME = ot_hdc_select
export PLATFORM = asap7
export VERILOG_FILES = /src/rtl/hdc/v41/ot_hdc_select.sv
...
export VERILOG_TOP_PARAMS = K 512 VW 16 IW 16 ORDER 1
export CORNER = TC
