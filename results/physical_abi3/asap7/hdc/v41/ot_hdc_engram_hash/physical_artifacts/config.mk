export DESIGN_NICKNAME = opentallas_ot_hdc_engram_hash_asap7
export DESIGN_NAME = ot_hdc_engram_hash
export PLATFORM = asap7
export VERILOG_FILES = /src/rtl/hdc/v41/ot_hdc_engram_tables_pkg.sv /src/rtl/hdc/v41/ot_hdc_engram_hash.sv
