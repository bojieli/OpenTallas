export DESIGN_NICKNAME = opentallas_ot_hdc_sinkhorn_asap7
export DESIGN_NAME = ot_hdc_sinkhorn
export PLATFORM = asap7
export VERILOG_FILES = /src/rtl/hdc/v41/ot_hdc_sinkhorn.sv /src/rtl/hdc/v41/ot_hdc_sk_arith.sv /src/rtl/hdc/v41/ot_hdc_sk_recip_rom.sv
