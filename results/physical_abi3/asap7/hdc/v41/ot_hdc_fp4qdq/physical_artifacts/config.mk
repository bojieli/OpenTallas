export DESIGN_NICKNAME = opentallas_ot_hdc_fp4qdq_asap7
export DESIGN_NAME = ot_hdc_fp4qdq
export PLATFORM = asap7
export VERILOG_FILES = /src/rtl/hdc/v41/ot_hdc_fp4qdq.sv /src/rtl/hdc/ot_hdc_delay.sv
