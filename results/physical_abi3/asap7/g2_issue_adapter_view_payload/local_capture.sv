...
module ot_a3_g2_array_issue_adapter #(
    ...
    // Validity owns these payloads. Capture can proceed during cancellation;
    // clear/reset revoke view_have so stale or cancelled data cannot launch.
    always @(posedge clk)begin
        if(view_valid && contraction_view)begin
