export DESIGN_NICKNAME = opentallas_ot_a3_lq8_operand_join_asap7
export DESIGN_NAME = ot_a3_lq8_operand_join
export PLATFORM = asap7
export VERILOG_FILES = /src/results/physical_abi3/asap7/runtime_operand_join/source_snapshots/baseline.sv
