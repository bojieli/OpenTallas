export DESIGN_NICKNAME = opentallas_ot_a3_operand_byte_mapper_asap7
export DESIGN_NAME = ot_a3_operand_byte_mapper
export PLATFORM = asap7
export VERILOG_FILES = /src/rtl/abi3/ot_a3_operand_byte_mapper.sv
