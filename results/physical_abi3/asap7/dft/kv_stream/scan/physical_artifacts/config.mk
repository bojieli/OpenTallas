export DESIGN_NICKNAME = opentallas_ot_hdc_kv_stream_asap7_scan
export DESIGN_NAME = ot_hdc_kv_stream
export PLATFORM = asap7
export VERILOG_FILES = /src/rtl/hdc/kv/ot_hdc_kv_walk.sv /src/rtl/hdc/kv/ot_hdc_kv_stream.sv
