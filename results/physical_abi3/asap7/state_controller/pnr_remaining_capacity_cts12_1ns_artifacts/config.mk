export DESIGN_NICKNAME = opentallas_ot_a3_state_controller_asap7
export DESIGN_NAME = ot_a3_state_controller
export PLATFORM = asap7
export VERILOG_FILES = /src/rtl/abi3/ot_a3_pkg.sv /src/results/rtl/state_remaining_capacity/candidate.sv
