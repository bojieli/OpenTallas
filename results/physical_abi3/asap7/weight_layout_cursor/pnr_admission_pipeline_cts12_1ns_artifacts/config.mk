export DESIGN_NICKNAME = opentallas_ot_a3_weight_layout_cursor_asap7
export DESIGN_NAME = ot_a3_weight_layout_cursor
export PLATFORM = asap7
export VERILOG_FILES = /src/rtl/abi3/ot_a3_weight_layout_cursor.sv
