...
6. **Letting the GPU choose its own parallelism is worth up to 283.84x to it.** At 554,700 mm2 on DeepSeek-V4-Pro-0813 the pipeline-only GPU delivers 1.11 tok/s and the same silicon running tensor delivers 314 tok/s.
7. **The advantage erodes with batch, and the erosion is a KV effect.** At batch 256 the aggregate ratio at equal area spans 0.91x (DeepSeek-V4-Pro-0813, ROM binding on `link_latency`) to 113.47x (DeepSeek-V4-Pro-0813, ROM binding on `link_latency`). Weight traffic is what ROM removes; KV traffic it does not, and KV traffic is what grows with batch.
8. **Sparse MoE buys aggregate throughput on a ROM machine, not latency.** DeepSeek-V4-Pro-0813 engages 4.4% of its ROM array at batch 1 and 4.8% at batch 256, while the weight-read time is identical at both. What the machine delivers rises from 82 to 16,607 tok/s, and its rate with every slot occupied from 16,561 to 16,607. The second rises far less than the first because the batch-1 figure is already a full-machine number -- this design has 203 slots -- so most of what batching adds there is coverage rather than occupancy. An unselected expert's read ports cannot be borrowed, so its idle bandwidth is only recovered by giving the sweep more users.
...
11. **A wafer has less die edge per unit area than the same area of separate dies, and that is an argument against it.** Perimeter grows as the square root of area, so HBM beachfront -- and therefore KV bandwidth -- does not scale with wafer area the way compute and ROM capacity do. This model charges both sides the same edge utilisation a shipping GPU achieves, and the consequence shows up wherever a design binds on `kv_read`: 0 of 1398 feasible points.
12. **The largest open question is not in this model's inputs but in the architecture, and a batch-1 anchor cannot settle its scaling law.** If a ROM cell both stores and multiplies, each concurrent stream needs its own pass and aggregate per-die throughput never exceeds the per-user rate. At batch 256 that costs up to 16.7x of aggregate throughput (DeepSeek-V4-Pro-0813). Their sweep counts coincide at batch 1, but their cell and pre-compute costs make their floorplans different; the current compute-in-ROM anchor reconstruction fails capacity. A batch-1 validation therefore cannot establish either high-batch law.
...
15. **No point in this study is power-limited.** Static power is charged per mm2 per second, so this is a statement about the designs rather than an artifact of a traffic-proportional energy model: the worst point here reaches 69% of its cooling budget. The companion study at the other node does have power-limited points.
...
- 9,503 tok/s aggregate with every slot full, over 27,932 resident sessions (fill limited by `pipeline_slots`)
- 12,145 W at 0.066 W/mm2, 1,278.0 mJ/token, thermal scale 1.000
...
| smallest feasible machine | `ROM-N6-native-SRAMKV-array-tensor-x188` | 153,220 | 715.7 | 4.7 | 1 | 2.02x |
| **after -- this report's rule** | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,375.7 | 12.8 | 27,932 | 6.63x |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | --- | ---: |
| `ROM-N6-native-HBMKV-wafer-hybrid-x4` **<-- recommended** | 184,900 | 4 | 2,375.7 | 9,503 | 12.8 | 27,932 | `link_latency` | 12,145 | 1,278.0 | `a100_sxm_80gb-x224-tensor` | 6.63x |

**Array or wafer, with the losing class's own best machine on the page.** A frontier can honestly be a single row -- that is what it means for one design to win on both axes at once -- and a single row tells a reader nothing about what it beat. Each class enters at its own optimum, never at its minimum-feasible machine, because comparing against a floor is how a class gets beaten by its own under-provisioning rather than by the other class.

| class | designs | pick | design | mm2 | user tok/s | tok/s per 1,000 mm2 | resident sessions |
| --- | ---: | --- | --- | ---: | ---: | ---: | ---: |
| array | 84 | densest | `ROM-N6-native-SRAMKV-array-tensor-x188` | 153,220 | 715.7 | 4.7 | 1 |
| array | 84 | fastest | `ROM-N6-native-SRAMKV-array-tensor-x191` | 155,665 | 725.9 | 4.7 | 1 |
| array | 84 | smallest | `ROM-N6-native-SRAMKV-array-tensor-x188` | 153,220 | 715.7 | 4.7 | 1 |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | array | `ROM-N6-native-SRAMKV-array-tensor-x191` | 155,665 | 725.9 | 726 | 1 | 9,562 | 13,173.6 | `link_latency` | `a100_sxm_80gb-x188-tensor` | 354.9 | 142,587 | 80,667.9 | 1.002 | 2.05x | 6.1x |
| 1 | wafer | `ROM-N6-native-SRAMKV-wafer-hybrid-x4` | 184,900 | 2,375.7 | 2,376 | 1 | 11,483 | 4,833.5 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 358.4 | 171,819 | 94,410.0 | 0.999 | 6.63x | 19.5x |
| 1 | array @ wafer area | `ROM-N6-native-SRAMKV-array-tensor-x227` | 185,005 | 725.1 | 725 | 1 | 11,470 | 15,819.6 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 358.4 | 171,819 | 94,410.0 | 1.000 | 2.02x | 6.0x |
| 1 | wafer reference | `ROM-N6-native-SRAMKV-wafer-hybrid-x4` | 184,900 | 2,375.7 | -- | 1 | -- | 4,833.5 | -- | -- | -- | -- | -- | 1.001 | 3.28x wafer/array | -- |
| 2 | array | `ROM-N6-native-HBMKV-array-tensor-x227` | 185,005 | 626.1 | 1,252 | 184,323 | 14,663 | 11,709.3 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 307.6 | 171,819 | 55,332.5 | 1.000 | 2.04x | 4.7x |
| 2 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,375.7 | 9,503 | 27,932 | 12,145 | 1,278.0 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 307.6 | 171,819 | 55,332.5 | 0.999 | 7.72x | 43.3x |
| 2 | array @ wafer area | `ROM-N6-native-HBMKV-array-tensor-x227` | 185,005 | 626.1 | 1,252 | 184,323 | 14,663 | 11,709.3 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 307.6 | 171,819 | 55,332.5 | 1.000 | 2.04x | 4.7x |
| 2 | wafer reference | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,375.7 | -- | 27,932 | -- | 1,278.0 | -- | -- | -- | -- | -- | 1.001 | 3.79x wafer/array | -- |
| 4 | array | `ROM-N6-native-HBMKV-array-hybrid-x206` | 167,890 | 587.0 | 15,261 | 167,271 | 12,212 | 800.2 | `weight_read` | `a100_sxm_80gb-x203-tensor` | 230.8 | 154,767 | 33,789.4 | 1.001 | 2.54x | 42.2x |
| 4 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,375.7 | 9,503 | 27,932 | 12,145 | 1,278.0 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 233.9 | 171,819 | 36,603.2 | 0.999 | 10.16x | 28.6x |
| 4 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x227` | 185,005 | 547.5 | 15,879 | 184,323 | 15,001 | 944.7 | `weight_read` | `a100_sxm_80gb-x224-tensor` | 233.9 | 171,819 | 36,603.2 | 1.000 | 2.34x | 38.7x |
| 4 | wafer reference | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,375.7 | -- | 27,932 | -- | 1,278.0 | -- | -- | -- | -- | -- | 1.001 | 4.34x wafer/array | -- |
| 8 | array | `ROM-N6-native-HBMKV-array-hybrid-x206` | 167,890 | 587.0 | 15,261 | 167,271 | 12,212 | 800.2 | `weight_read` | `a100_sxm_80gb-x203-tensor` | 170.1 | 154,767 | 23,179.2 | 1.001 | 3.45x | 29.0x |
| 8 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,374.1 | 18,993 | 27,932 | 12,281 | 646.6 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 172.0 | 171,819 | 25,143.4 | 0.999 | 13.80x | 38.9x |
| 8 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x227` | 185,005 | 547.5 | 15,879 | 184,323 | 15,001 | 944.7 | `weight_read` | `a100_sxm_80gb-x224-tensor` | 172.0 | 171,819 | 25,143.4 | 1.000 | 3.18x | 26.6x |
| 8 | wafer reference | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,374.1 | -- | 27,932 | -- | 646.6 | -- | -- | -- | -- | -- | 1.001 | 4.34x wafer/array | -- |
| 16 | array | `ROM-N6-native-HBMKV-array-hybrid-x206` | 167,890 | 587.0 | 15,261 | 167,271 | 12,212 | 800.2 | `weight_read` | `a100_sxm_80gb-x203-tensor` | 116.4 | 154,767 | 17,128.0 | 1.001 | 5.04x | 21.4x |
| 16 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,370.9 | 37,934 | 27,932 | 12,552 | 330.9 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 118.1 | 171,819 | 18,512.7 | 0.999 | 20.08x | 56.0x |
| 16 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x227` | 185,005 | 547.5 | 15,879 | 184,323 | 15,001 | 944.7 | `weight_read` | `a100_sxm_80gb-x224-tensor` | 118.1 | 171,819 | 18,512.7 | 1.000 | 4.64x | 19.6x |
| 16 | wafer reference | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,370.9 | -- | 27,932 | -- | 330.9 | -- | -- | -- | -- | -- | 1.001 | 4.33x wafer/array | -- |
| 32 | array | `ROM-N6-native-HBMKV-array-hybrid-x227` | 185,005 | 546.6 | 17,490 | 184,323 | 15,024 | 859.0 | `weight_read` | `a100_sxm_80gb-x224-tensor` | 76.2 | 171,819 | 14,439.8 | 1.000 | 7.18x | 16.8x |
| 32 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,052.2 | 65,670 | 27,932 | 12,931 | 196.9 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 76.2 | 171,819 | 14,439.8 | 0.999 | 26.94x | 73.3x |
| 32 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x227` | 185,005 | 546.6 | 17,490 | 184,323 | 15,024 | 859.0 | `weight_read` | `a100_sxm_80gb-x224-tensor` | 76.2 | 171,819 | 14,439.8 | 1.000 | 7.18x | 16.8x |
| 32 | wafer reference | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,052.2 | -- | 27,932 | -- | 196.9 | -- | -- | -- | -- | -- | 1.001 | 3.75x wafer/array | -- |
| 64 | array | `ROM-N6-native-HBMKV-array-hybrid-x227` | 185,005 | 536.4 | 34,331 | 184,323 | 15,264 | 444.6 | `weight_read` | `a100_sxm_80gb-x224-tensor` | 46.6 | 171,819 | 11,766.1 | 1.000 | 11.52x | 26.5x |
| 64 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x6` | 277,350 | 1,951.9 | 124,920 | 41,899 | 27,440 | 219.7 | `link_latency` | `a100_sxm_80gb-x336-tensor` | 47.2 | 262,763 | 16,973.9 | 0.999 | 41.35x | 77.3x |
| 64 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x340` | 277,100 | 413.5 | 26,466 | 220,863 | 29,153 | 1,101.5 | `weight_read` | `a100_sxm_80gb-x335-tensor` | 47.2 | 261,951 | 16,930.8 | 1.001 | 8.76x | 15.4x |
| 64 | wafer reference | `ROM-N6-native-HBMKV-wafer-hybrid-x6` | 277,350 | 1,951.9 | -- | 41,899 | -- | 219.7 | -- | -- | -- | -- | -- | 0.999 | 4.72x wafer/array | -- |
| 256 | array | `ROM-N6-native-HBMKV-array-hybrid-x297` | 242,055 | 416.0 | 106,491 | 192,930 | 24,712 | 232.1 | `weight_read` | `a100_sxm_80gb-x293-tensor` | 15.5 | 227,847 | 11,025.0 | 1.000 | 26.86x | 47.5x |
| 256 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x12-romfill` | 554,700 | 1,776.5 | 454,776 | 83,798 | 58,063 | 127.7 | `link_latency` | `a100_sxm_80gb-x672-tensor` | 15.7 | 535,594 | 24,564.9 | 0.999 | 113.47x | 192.4x |

**The best design differs by batch, and here is where it changes.**

| batches | design | mm2 | class | KV | resident sessions |
| --- | --- | ---: | --- | --- | ---: |
| 1-64 | `ROM-N6-native-HBMKV-wafer-hybrid-x4` | 184,900 | wafer | HBM | 27,932 |
...
- **0 of 1,398 feasible points (0.0%) are power-limited.**
- 0 points are uncoolable at any speed (static power alone at or above the cooling budget).

Nothing in this study is power-limited. That is a statement about these designs and not an artifact of the energy model: static power is charged per mm2 per second, so a design cannot escape it by moving fewer bytes. The busiest point reaches 69% of its cooling budget, and the busiest wafer-scale ROM design 26%. The companion study at the other node, whose HBM generation delivers more than twice the bandwidth per stack, does have power-limited points.

| Family | Area class | Points | Throttled | Median power / budget | Worst power / budget | Peak W/mm2 | Median static share |
|---|---|---:|---:|---:|---:|---:|---:|
| gpu | large array (5,000-40,000 mm2) | 24 | 0 | 59.2% | 68.6% | 0.332 | 61% |
| gpu | wafer (>=40,000 mm2) | 504 | 0 | 38.6% | 53.9% | 0.261 | 94% |
| rom | wafer (>=40,000 mm2) | 870 | 0 | 16.2% | 25.6% | 0.128 | 99% |
...
|---|---:|---:|---|---:|---:|---|---|---:|---:|---|---:|
| DeepSeek-V4-Pro-0813 | 1 | 184,900 | `DSV4-Pro/ROM-N6-native-SRAMKV-wafer-hybrid-x4` | 4.833488 | 11,483.0 | link_latency | `DSV4-Pro/a100_sxm_80gb-x224-tensor` | 94.410036 | 33,841.1 | link_latency | 19.53x |
| DeepSeek-V4-Pro-0813 | 2 | 184,900 | `DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4` | 1.277979 | 12,144.5 | link_latency | `DSV4-Pro/a100_sxm_80gb-x224-tensor` | 55.332545 | 34,041.2 | link_latency | 43.30x |
| DeepSeek-V4-Pro-0813 | 4 | 184,900 | `DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4` | 1.277979 | 12,144.5 | link_latency | `DSV4-Pro/a100_sxm_80gb-x224-tensor` | 36.603173 | 34,247.3 | weight_read | 28.64x |
| DeepSeek-V4-Pro-0813 | 8 | 184,900 | `DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4` | 0.646608 | 12,280.9 | link_latency | `DSV4-Pro/a100_sxm_80gb-x224-tensor` | 25.143428 | 34,604.2 | link_latency | 38.89x |
| DeepSeek-V4-Pro-0813 | 16 | 184,900 | `DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4` | 0.330877 | 12,551.5 | link_latency | `DSV4-Pro/a100_sxm_80gb-x224-tensor` | 18.512659 | 34,971.2 | link_latency | 55.95x |
| DeepSeek-V4-Pro-0813 | 32 | 184,900 | `DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4` | 0.196910 | 12,931.1 | link_latency | `DSV4-Pro/a100_sxm_80gb-x224-tensor` | 14.439759 | 35,193.0 | link_latency | 73.33x |
| DeepSeek-V4-Pro-0813 | 64 | 277,350 | `DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x6` | 0.219660 | 27,440.0 | link_latency | `DSV4-Pro/a100_sxm_80gb-x336-tensor` | 16.973920 | 51,274.4 | link_latency | 77.27x |
| DeepSeek-V4-Pro-0813 | 256 | 554,700 | `DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x12-romfill` | 0.127674 | 58,063.1 | link_latency | `DSV4-Pro/a100_sxm_80gb-x672-tensor` | 24.564873 | 98,450.1 | link_latency | 192.40x |
...
|---|---:|---:|---:|---|---:|---|---:|---:|---|---:|---|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 4 | 184,900 | 14,625.7 | wafer-pipeline | 2,375.7 | wafer-hybrid | 6.16x | 617.3 | pipeline | 358.4 | tensor | 1.72x | 23.69x | 6.63x | 0.28x |
| DeepSeek-V4-Pro-0813 | 6 | 277,350 | 14,625.7 | wafer-pipeline | 1,969.6 | wafer-hybrid | 7.43x | 637.5 | pipeline | 309.0 | tensor | 2.06x | 22.94x | 6.37x | 0.28x |
| DeepSeek-V4-Pro-0813 | 8 | 369,800 | 16,984.1 | wafer-pipeline | 1,928.5 | wafer-hybrid | 8.81x | 648.2 | pipeline | 311.4 | tensor | 2.08x | 26.20x | 6.19x | 0.24x |
| DeepSeek-V4-Pro-0813 | 12 | 554,700 | 20,293.2 | wafer-pipeline | 1,855.6 | wafer-hybrid | 10.94x | 659.4 | pipeline | 313.8 | tensor | 2.10x | 30.78x | 5.91x | 0.19x |
...
|---|---:|---|---|---:|---:|---:|---|---|---:|---:|---|---:|---:|---:|---|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 1 | fastest | DSV4-Pro/ROM-N6-native-SRAMKV-wafer-hybrid-x4 | 184,900 | 2,375.7 | 2,375.7 | link_latency | DSV4-Pro/a100_sxm_80gb-x224-tensor | 185,024 | 1.00x | tensor | 1,323.01 | 358.4 | 358.4 | link_latency | 6.63x | 6.63x | 771.61x | 6.63x |
| DeepSeek-V4-Pro-0813 | 1 | smallest silicon | DSV4-Pro/ROM-N6-native-SRAMKV-array-tensor-x188 | 153,220 | 715.7 | 715.7 | link_latency | DSV4-Pro/a100_sxm_80gb-x185-tensor | 152,810 | 1.00x | tensor | 1,321.76 | 354.5 | 354.5 | weight_read | 2.02x | 2.02x | 196.27x | 2.02x |
| DeepSeek-V4-Pro-0813 | 2 | fastest | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,375.7 | 9,502.9 | link_latency | DSV4-Pro/a100_sxm_80gb-x224-tensor | 185,024 | 1.00x | tensor | 1,540.69 | 307.6 | 615.2 | link_latency | 7.72x | 15.45x | 771.61x | 7.72x |
| DeepSeek-V4-Pro-0813 | 2 | smallest silicon | DSV4-Pro/ROM-N6-native-HBMKV-array-tensor-x203 | 165,445 | 596.6 | 1,193.2 | link_latency | DSV4-Pro/a100_sxm_80gb-x200-tensor | 165,200 | 1.00x | tensor | 1,538.90 | 303.9 | 607.8 | weight_read | 1.96x | 1.96x | 175.20x | 1.96x |
| DeepSeek-V4-Pro-0813 | 4 | fastest | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,375.7 | 9,502.9 | link_latency | DSV4-Pro/a100_sxm_80gb-x224-tensor | 185,024 | 1.00x | tensor | 1,976.07 | 233.9 | 935.6 | weight_read | 10.16x | 10.16x | 771.61x | 10.16x |
| DeepSeek-V4-Pro-0813 | 4 | smallest silicon | DSV4-Pro/ROM-N6-native-HBMKV-array-tensor-x203 | 165,445 | 448.5 | 1,794.1 | link_latency | DSV4-Pro/a100_sxm_80gb-x200-tensor | 165,200 | 1.00x | tensor | 1,972.47 | 230.3 | 921.4 | weight_read | 1.95x | 1.95x | 131.72x | 1.95x |
| DeepSeek-V4-Pro-0813 | 8 | fastest | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,374.1 | 18,992.9 | link_latency | DSV4-Pro/a100_sxm_80gb-x224-tensor | 185,024 | 1.00x | tensor | 2,846.82 | 172.0 | 1,376.3 | link_latency | 13.80x | 13.80x | 771.09x | 13.80x |
| DeepSeek-V4-Pro-0813 | 8 | smallest silicon | DSV4-Pro/ROM-N6-native-HBMKV-array-hybrid-x203 | 165,445 | 443.2 | 11,524.3 | compute | DSV4-Pro/a100_sxm_80gb-x200-tensor | 165,200 | 1.00x | tensor | 2,839.62 | 169.9 | 1,359.0 | link_latency | 2.61x | 8.48x | 130.17x | 2.61x |
| DeepSeek-V4-Pro-0813 | 16 | fastest | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,370.9 | 37,934.1 | link_latency | DSV4-Pro/a100_sxm_80gb-x224-tensor | 185,024 | 1.00x | tensor | 4,588.31 | 118.1 | 1,889.0 | link_latency | 20.08x | 20.08x | 770.04x | 20.08x |
| DeepSeek-V4-Pro-0813 | 16 | smallest silicon | DSV4-Pro/ROM-N6-native-HBMKV-array-hybrid-x203 | 165,445 | 443.2 | 11,524.3 | compute | DSV4-Pro/a100_sxm_80gb-x200-tensor | 165,200 | 1.00x | tensor | 4,573.92 | 116.2 | 1,859.4 | link_latency | 3.81x | 6.20x | 130.17x | 3.81x |
| DeepSeek-V4-Pro-0813 | 32 | fastest | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,052.2 | 65,670.2 | link_latency | DSV4-Pro/a100_sxm_80gb-x224-tensor | 185,024 | 1.00x | tensor | 8,071.31 | 76.2 | 2,437.2 | link_latency | 26.94x | 26.94x | 666.53x | 26.94x |
| DeepSeek-V4-Pro-0813 | 32 | smallest silicon | DSV4-Pro/ROM-N6-native-HBMKV-array-hybrid-x203 | 165,445 | 381.7 | 12,212.8 | compute | DSV4-Pro/a100_sxm_80gb-x200-tensor | 165,200 | 1.00x | tensor | 8,042.52 | 75.0 | 2,400.9 | link_latency | 5.09x | 5.09x | 112.08x | 5.09x |
| DeepSeek-V4-Pro-0813 | 64 | fastest | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x6 | 277,350 | 1,951.9 | 124,920.5 | link_latency | DSV4-Pro/a100_sxm_80gb-x336-tensor | 277,536 | 1.00x | tensor | 15,692.52 | 47.2 | 3,020.8 | link_latency | 41.35x | 41.35x | 917.07x | 41.35x |
| DeepSeek-V4-Pro-0813 | 64 | smallest silicon | DSV4-Pro/ROM-N6-native-HBMKV-array-hybrid-x203 | 165,445 | 219.2 | 14,028.9 | compute | DSV4-Pro/a100_sxm_80gb-x200-tensor | 165,200 | 1.00x | tensor | 14,979.72 | 46.0 | 2,944.1 | link_latency | 4.77x | 4.77x | 64.37x | 4.77x |
| DeepSeek-V4-Pro-0813 | 256 | fastest | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x12-romfill | 554,700 | 1,776.5 | 454,775.5 | link_latency | DSV4-Pro/a100_sxm_80gb-x672-tensor | 555,072 | 1.00x | tensor | 58,607.78 | 15.7 | 4,007.8 | link_latency | 113.47x | 113.47x | 1606.86x | 113.47x |
| DeepSeek-V4-Pro-0813 | 256 | smallest silicon | DSV4-Pro/ROM-N6-native-HBMKV-array-pipeline-x203 | 165,445 | 64.9 | 16,606.8 | compute | DSV4-Pro/a100_sxm_80gb-x200-tensor | 165,200 | 1.00x | tensor | 56,602.93 | 15.3 | 3,923.1 | link_latency | 4.23x | 4.23x | 19.88x | 4.23x |
...
|---|---:|---:|---:|---:|---:|---|---:|---:|---|
| DeepSeek-V4-Pro-0813 | 13 | 10,738 | 22.1 | 211.6 | 131.4 | tensor | 1,225.56 | 25.9% | weight_read |
...
| DeepSeek-V4-Pro-0813 | 168 | 138,768 | 4.0 | 352.4 | 31.1 | tensor | 1,320.51 | 46.5% | weight_read |
...
| DeepSeek-V4-Pro-0813 | 245 | 202,370 | 2.8 | 360.1 | 22.1 | tensor | 1,323.73 | 47.7% | link_latency |
...
| DeepSeek-V4-Pro-0813 | 394 | 325,444 | 1.8 | 310.4 | 14.3 | tensor | 1,821.63 | 56.5% | link_latency |
...
| DSV4-Pro/a100_sxm_80gb-x13-pipeline | DeepSeek-V4-Pro-0813 | 13 | pipeline | nvlink3 | infiniband_hdr | 12 | 30.63 us | 3,264.9 tok/s | 32,648.7 tok/s | 11 x point_to_point span 2 on nvlink3 (traversals 1.0) = 28.03 us; 1 x point_to_point span 2 on infiniband_hdr (traversals 1.0) = 2.60 us |
| DSV4-Pro/a100_sxm_80gb-x13-tensor | DeepSeek-V4-Pro-0813 | 13 | tensor | nvlink3 | infiniband_hdr | 244 | 1,225.56 us | 81.6 tok/s | 816.0 tok/s | 122 x all_reduce span 8 on nvlink3 (traversals 2.0) = 625.30 us; 122 x all_reduce span 2 on infiniband_hdr (traversals 2.0) = 600.26 us |
| DSV4-Pro/a100_sxm_80gb-x13-hybrid | DeepSeek-V4-Pro-0813 | 13 | hybrid | nvlink3 | infiniband_hdr | 123 | 627.91 us | 159.3 tok/s | 1,592.6 tok/s | 122 x all_reduce span 8 on nvlink3 (traversals 2.0) = 625.30 us; 1 x point_to_point span 2 on infiniband_hdr (traversals 1.0) = 2.60 us |
...
| DSV4-Pro/a100_sxm_80gb-x394-pipeline | DeepSeek-V4-Pro-0813 | 394 | pipeline | nvlink3 | infiniband_hdr | 60 | 153.26 us | 652.5 tok/s | 6,525.0 tok/s | 53 x point_to_point span 2 on nvlink3 (traversals 1.0) = 135.03 us; 7 x point_to_point span 2 on infiniband_hdr (traversals 1.0) = 18.22 us |
| DSV4-Pro/a100_sxm_80gb-x394-tensor | DeepSeek-V4-Pro-0813 | 394 | tensor | nvlink3 | infiniband_hdr | 244 | 1,821.63 us | 54.9 tok/s | 549.0 tok/s | 122 x all_reduce span 8 on nvlink3 (traversals 2.0) = 625.30 us; 122 x all_reduce span 50 on infiniband_hdr (traversals 4.0) = 1,196.32 us |
| DSV4-Pro/a100_sxm_80gb-x394-hybrid | DeepSeek-V4-Pro-0813 | 394 | hybrid | nvlink3 | infiniband_hdr | 171 | 752.87 us | 132.8 tok/s | 1,328.2 tok/s | 122 x all_reduce span 8 on nvlink3 (traversals 2.0) = 625.30 us; 49 x point_to_point span 2 on infiniband_hdr (traversals 1.0) = 127.57 us |
...
|---|---:|---|---|---|---:|---:|---:|---:|---:|---:|---|
| DeepSeek-V4-Pro-0813 | 1 | wafer | wafer | DSV4-Pro/ROM-N6-native-SRAMKV-wafer-hybrid-x4 | 184,900 | 2,375.7 | 0.013 | 715.7 (153,220) | 2,375.7 (184,900) | 3.32x | link_latency |
| DeepSeek-V4-Pro-0813 | 2 | wafer | wafer | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,375.7 | 0.013 | 596.6 (165,445) | 2,375.7 (184,900) | 3.98x | link_latency |
| DeepSeek-V4-Pro-0813 | 4 | wafer | wafer | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,375.7 | 0.013 | 587.0 (167,890) | 2,375.7 (184,900) | 4.05x | link_latency |
| DeepSeek-V4-Pro-0813 | 8 | wafer | wafer | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,374.1 | 0.013 | 587.0 (167,890) | 2,374.1 (184,900) | 4.04x | link_latency |
| DeepSeek-V4-Pro-0813 | 16 | wafer | wafer | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,370.9 | 0.013 | 587.0 (167,890) | 2,370.9 (184,900) | 4.04x | link_latency |
| DeepSeek-V4-Pro-0813 | 32 | wafer | wafer | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,052.2 | 0.011 | 522.7 (167,890) | 2,052.2 (184,900) | 3.93x | link_latency |
...
| DeepSeek-V4-Pro-0813 | 256 | wafer | wafer | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x12-romfill | 554,700 | 1,776.5 | 0.003 | 399.4 (202,120) | 1,776.5 (554,700) | 4.45x | link_latency |
...
| DeepSeek-V4-Pro-0813 | 32 | sram | 65,670.2 | 26,061.7 | 45,964.8 | 2.52x | 1.76x | link_latency | weight_read | weight_read |
...
| DeepSeek-V4-Pro-0813 | 32 | rom | 65,670.2 | 27,161.9 | 47,093.4 | 2.42x | 1.73x | link_latency | weight_read | weight_read |
| DeepSeek-V4-Pro-0813 | 64 | rom | 124,920.5 | 27,161.9 | 77,855.6 | 4.60x | 2.87x | link_latency | weight_read | weight_read |
| DeepSeek-V4-Pro-0813 | 256 | rom | 454,775.5 | 27,161.9 | 203,237.3 | 16.74x | 7.48x | link_latency | weight_read | weight_read |
...
| DeepSeek-V4-Pro-0813 | 32 | batched | sram | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 1.00 | 1.00 | 65,670.2 | 0.355 | link_latency | 1.00x |
| DeepSeek-V4-Pro-0813 | 32 | batched | rom | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x4-romfill | 184,900 | 1.00 | 1.00 | 65,670.2 | 0.355 | link_latency | 1.00x |
...
| DeepSeek-V4-Pro-0813 | 32 | per_stream | rom | DSV4-Pro/ROM-N6-native-HBMKV-wafer-pipeline-x7-perstream-romfill | 323,575 | 1.04 | 1.00 | 27,161.9 | 0.084 | weight_read | 0.41x |
| DeepSeek-V4-Pro-0813 | 32 | per_region | sram | DSV4-Pro/ROM-N6-native-SRAMKV-wafer-hybrid-x7-perregion | 323,575 | 1.00 | 1.53 | 45,964.8 | 0.142 | weight_read | 0.70x |
| DeepSeek-V4-Pro-0813 | 32 | per_region | rom | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x7-perregion-romfill | 323,575 | 1.04 | 1.53 | 47,093.4 | 0.146 | weight_read | 0.72x |
...
| DeepSeek-V4-Pro-0813 | 256 | batched | rom | DSV4-Pro/ROM-N6-native-HBMKV-wafer-hybrid-x12-romfill | 554,700 | 1.97 | 1.00 | 454,775.5 | 0.820 | link_latency | 1.09x |
...
| DeepSeek-V4-Pro-0813 | 256 | per_region | sram | DSV4-Pro/ROM-N6-native-SRAMKV-wafer-hybrid-x7-perregion | 323,575 | 1.00 | 3.72 | 196,914.3 | 0.609 | weight_read | 0.47x |
...
| DeepSeek-V4-Pro-0813 | 4 | 376 | 1.00 | 1.000 | 1.000 | 1.00x |
| DeepSeek-V4-Pro-0813 | 8 | 376 | 1.00 | 1.000 | 1.000 | 1.00x |
...
|---|---:|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 1 | 13 | 4.96 | 3.49 | 1.42x |
| DeepSeek-V4-Pro-0813 | 2 | 13 | 4.96 | 3.49 | 1.42x |
| DeepSeek-V4-Pro-0813 | 4 | 13 | 4.96 | 3.49 | 1.42x |
| DeepSeek-V4-Pro-0813 | 8 | 13 | 4.96 | 3.49 | 1.42x |
| DeepSeek-V4-Pro-0813 | 16 | 13 | 5.79 | 3.77 | 1.54x |
| DeepSeek-V4-Pro-0813 | 32 | 13 | 8.96 | 4.82 | 1.86x |
| DeepSeek-V4-Pro-0813 | 64 | 13 | 11.69 | 5.96 | 1.96x |
| DeepSeek-V4-Pro-0813 | 256 | 13 | 13.00 | 8.11 | 1.60x |
...
| DeepSeek-V4-Pro-0813 | 1 | 394 | 5.96 | 5.80 | 1.03x |
| DeepSeek-V4-Pro-0813 | 2 | 394 | 5.96 | 5.80 | 1.03x |
| DeepSeek-V4-Pro-0813 | 4 | 394 | 5.96 | 5.80 | 1.03x |
| DeepSeek-V4-Pro-0813 | 8 | 394 | 5.96 | 5.80 | 1.03x |
| DeepSeek-V4-Pro-0813 | 16 | 394 | 5.96 | 5.80 | 1.03x |
| DeepSeek-V4-Pro-0813 | 32 | 394 | 5.96 | 5.80 | 1.03x |
| DeepSeek-V4-Pro-0813 | 64 | 394 | 5.96 | 5.80 | 1.03x |
| DeepSeek-V4-Pro-0813 | 256 | 394 | 5.96 | 5.80 | 1.03x |
...
|---|---:|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 1 | 376 | 9.04% | 203.71 | 5.99 |
| DeepSeek-V4-Pro-0813 | 2 | 376 | 9.04% | 203.71 | 5.99 |
| DeepSeek-V4-Pro-0813 | 4 | 376 | 9.04% | 203.71 | 5.99 |
| DeepSeek-V4-Pro-0813 | 8 | 376 | 9.04% | 203.71 | 5.99 |
| DeepSeek-V4-Pro-0813 | 16 | 7 | 0.26% | 6.22 | 5.99 |
| DeepSeek-V4-Pro-0813 | 32 | 7 | 0.26% | 6.22 | 5.99 |
| DeepSeek-V4-Pro-0813 | 64 | 7 | 0.26% | 6.22 | 5.99 |
| DeepSeek-V4-Pro-0813 | 256 | 7 | 0.26% | 6.22 | 5.99 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 1 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 81.6 | 16,560.7 |
| DeepSeek-V4-Pro-0813 | 2 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 81.6 | 16,560.7 |
| DeepSeek-V4-Pro-0813 | 4 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 81.6 | 16,560.7 |
| DeepSeek-V4-Pro-0813 | 8 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 81.6 | 16,560.7 |
| DeepSeek-V4-Pro-0813 | 16 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 81.6 | 16,560.7 |
| DeepSeek-V4-Pro-0813 | 32 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 81.6 | 16,560.7 |
| DeepSeek-V4-Pro-0813 | 64 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 81.6 | 16,560.7 |
| DeepSeek-V4-Pro-0813 | 256 | 1.97% | 43.0 GB | 4.82% | 1,247.25 TB/s | 25,902.15 TB/s | 64.9 | 16,606.8 |

## Binding constraint census

| Family | Binding constraint | Points |
|---|---|---:|
| gpu | link_latency | 141 |
| gpu | weight_read | 387 |
| rom | compute | 55 |
| rom | infeasible | 570 |
