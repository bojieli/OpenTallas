...
6. **Letting the GPU choose its own parallelism is worth up to 152.81x to it.** At 554,700 mm2 on DeepSeek-V4-Flash-0731 the pipeline-only GPU delivers 4.11 tok/s and the same silicon running tensor delivers 628 tok/s.
7. **The advantage erodes with batch, and the erosion is a KV effect.** At batch 256 the aggregate ratio at equal area spans 0.61x (DeepSeek-V4-Flash-0731, ROM binding on `link_latency`) to 81.63x (DeepSeek-V4-Flash-0731, ROM binding on `link_latency`). Weight traffic is what ROM removes; KV traffic it does not, and KV traffic is what grows with batch.
8. **Sparse MoE buys aggregate throughput on a ROM machine, not latency.** DeepSeek-V4-Flash-0731 engages 6.7% of its ROM array at batch 1 and 17.4% at batch 256, while the weight-read time is identical at both. What the machine delivers rises from 572 to 23,490 tok/s, and its rate with every slot occupied from 22,290 to 23,490. The second rises far less than the first because the batch-1 figure is already a full-machine number -- this design has 39 slots -- so most of what batching adds there is coverage rather than occupancy. An unselected expert's read ports cannot be borrowed, so its idle bandwidth is only recovered by giving the sweep more users.
...
11. **A wafer has less die edge per unit area than the same area of separate dies, and that is an argument against it.** Perimeter grows as the square root of area, so HBM beachfront -- and therefore KV bandwidth -- does not scale with wafer area the way compute and ROM capacity do. This model charges both sides the same edge utilisation a shipping GPU achieves, and the consequence shows up wherever a design binds on `kv_read`: 2 of 2008 feasible points.
...
- 4,708 tok/s aggregate with every slot full, over 9,987 resident sessions (fill limited by `batch`)
- 3,988 W at 0.086 W/mm2, 847.0 mJ/token, thermal scale 1.000
...
| user tok/s | 4,707.9 | 723.3 | 6.51x |
| aggregate tok/s | 4,708 | 723 | 6.51x |
| resident sessions | 9,987 | 62,343 | -- |
| J/token | 0.8470 | 12.3624 | 14.6x |

The areas match to within 2%, so no granularity correction is needed on this row.

**Read the resident-session row before the ratio row.** A per-user rate divided by a per-user rate is a latency claim, and a latency claim taken from a machine that holds 9,987 sessions against one that holds 62,343 is not the trade it looks like. Where those two numbers are far apart the honest reading is the batch-regime table below, not this row.
...
| smallest feasible machine | `ROM-N6-native-SRAMKV-array-hybrid-x36` | 29,340 | 1,465.9 | 50.0 | 1 | 2.14x |
| **after -- this report's rule** | `ROM-N6-native-HBMKV-wafer-tensor-x1` | 46,225 | 4,707.9 | 101.8 | 9,987 | 6.51x |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | --- | ---: |
| `ROM-N6-native-HBMKV-wafer-tensor-x1` **<-- recommended** | 46,225 | 1 | 4,707.9 | 4,708 | 101.8 | 9,987 | `link_latency` | 3,988 | 847.0 | `a100_sxm_80gb-x56-tensor` | 6.51x |
...
| array | 144 | smallest | `ROM-N6-native-SRAMKV-array-hybrid-x36` | 29,340 | 1,465.9 | 50.0 | 1 |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | array | `ROM-N6-native-SRAMKV-array-hybrid-x37` | 30,155 | 1,539.7 | 1,540 | 1 | 1,857 | 1,206.3 | `link_latency` | `a100_sxm_80gb-x37-tensor` | 687.3 | 40,278 | 8,956.4 | 0.987 | 2.24x | 7.4x |
| 1 | wafer | `ROM-N6-native-SRAMKV-wafer-tensor-x1` | 46,225 | 4,707.9 | 4,708 | 1 | 3,851 | 817.9 | `link_latency` | `a100_sxm_80gb-x56-tensor` | 723.3 | 62,343 | 12,362.4 | 0.999 | 6.51x | 15.1x |
| 1 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x56` | 45,640 | 1,368.4 | 9,579 | 65,035 | 4,604 | 480.6 | `link_latency` | `a100_sxm_80gb-x55-tensor` | 721.9 | 61,182 | 12,185.1 | 1.005 | 1.90x | 25.4x |
| 1 | wafer reference | `ROM-N6-native-SRAMKV-wafer-tensor-x1` | 46,225 | 4,707.9 | -- | 1 | -- | 817.9 | -- | -- | -- | -- | -- | 0.987 | 3.44x wafer/array | -- |
| 2 | array | `ROM-N6-native-HBMKV-array-hybrid-x40` | 32,600 | 1,539.7 | 7,699 | 46,453 | 2,475 | 321.4 | `link_latency` | `a100_sxm_80gb-x39-tensor` | 583.6 | 42,600 | 5,596.4 | 1.012 | 2.64x | 17.4x |
| 2 | wafer | `ROM-N6-native-HBMKV-wafer-tensor-x1` | 46,225 | 4,707.9 | 9,416 | 9,987 | 4,013 | 426.2 | `link_latency` | `a100_sxm_80gb-x56-tensor` | 614.8 | 62,343 | 7,347.6 | 0.999 | 7.66x | 17.2x |
| 2 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x56` | 45,640 | 1,368.4 | 9,579 | 65,035 | 4,604 | 480.6 | `link_latency` | `a100_sxm_80gb-x55-tensor` | 613.1 | 61,182 | 7,247.4 | 1.005 | 2.23x | 15.1x |
| 2 | wafer reference | `ROM-N6-native-HBMKV-wafer-tensor-x1` | 46,225 | 4,707.9 | -- | 9,987 | -- | 426.2 | -- | -- | -- | -- | -- | 0.987 | 3.44x wafer/array | -- |
| 4 | array | `ROM-N6-native-HBMKV-array-hybrid-x40` | 32,600 | 1,539.7 | 7,699 | 46,453 | 2,475 | 321.4 | `link_latency` | `a100_sxm_80gb-x39-tensor` | 468.3 | 42,600 | 3,565.3 | 1.012 | 3.29x | 11.1x |
| 4 | wafer | `ROM-N6-native-HBMKV-wafer-tensor-x1` | 46,225 | 4,707.9 | 18,832 | 9,987 | 4,062 | 215.7 | `link_latency` | `a100_sxm_80gb-x56-tensor` | 495.6 | 62,343 | 4,638.1 | 0.999 | 9.50x | 21.5x |
| 4 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x56` | 45,640 | 1,368.4 | 9,579 | 65,035 | 4,604 | 480.6 | `link_latency` | `a100_sxm_80gb-x55-tensor` | 494.1 | 61,182 | 4,576.9 | 1.005 | 2.77x | 9.5x |
| 4 | wafer reference | `ROM-N6-native-HBMKV-wafer-tensor-x1` | 46,225 | 4,707.9 | -- | 9,987 | -- | 215.7 | -- | -- | -- | -- | -- | 0.987 | 3.44x wafer/array | -- |
| 8 | array | `ROM-N6-native-HBMKV-array-hybrid-x40` | 32,600 | 1,455.3 | 11,643 | 46,453 | 2,495 | 214.3 | `link_latency` | `a100_sxm_80gb-x39-tensor` | 350.7 | 42,600 | 2,448.2 | 1.012 | 4.15x | 11.4x |
| 8 | wafer | `ROM-N6-native-HBMKV-wafer-tensor-x1` | 46,225 | 4,707.9 | 37,663 | 9,987 | 4,160 | 110.5 | `link_latency` | `a100_sxm_80gb-x56-tensor` | 374.0 | 62,343 | 3,143.9 | 0.999 | 12.59x | 28.5x |
| 8 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x56` | 45,640 | 1,366.3 | 10,930 | 65,035 | 4,611 | 421.9 | `link_latency` | `a100_sxm_80gb-x55-tensor` | 372.7 | 61,182 | 3,104.9 | 1.005 | 3.67x | 7.4x |
| 8 | wafer reference | `ROM-N6-native-HBMKV-wafer-tensor-x1` | 46,225 | 4,707.9 | -- | 9,987 | -- | 110.5 | -- | -- | -- | -- | -- | 0.987 | 3.45x wafer/array | -- |
| 16 | array | `ROM-N6-native-HBMKV-array-hybrid-x47` | 38,305 | 1,422.2 | 22,756 | 54,583 | 3,482 | 153.0 | `link_latency` | `a100_sxm_80gb-x46-tensor` | 254.2 | 50,730 | 1,994.5 | 1.008 | 5.60x | 13.0x |
| 16 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x2-romfill` | 92,450 | 4,406.4 | 70,503 | 19,975 | 8,988 | 127.5 | `link_latency` | `a100_sxm_80gb-x112-tensor` | 291.0 | 127,378 | 3,834.3 | 0.999 | 15.14x | 30.1x |
| 16 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x111-romfill` | 90,465 | 1,229.0 | 19,664 | 128,909 | 10,194 | 518.4 | `link_latency` | `a100_sxm_80gb-x110-tensor` | 290.3 | 125,056 | 3,781.2 | 0.996 | 4.23x | 7.3x |
| 16 | wafer reference | `ROM-N6-native-HBMKV-wafer-hybrid-x2-romfill` | 92,450 | 4,406.4 | -- | 19,975 | -- | 127.5 | -- | -- | -- | -- | -- | 0.979 | 3.59x wafer/array | -- |
| 32 | array | `ROM-N6-native-HBMKV-array-hybrid-x56` | 45,640 | 1,316.1 | 42,116 | 65,035 | 4,775 | 113.4 | `link_latency` | `a100_sxm_80gb-x55-tensor` | 175.1 | 61,182 | 1,705.3 | 1.005 | 7.52x | 15.0x |
| 32 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x2-romfill` | 92,450 | 4,312.9 | 138,012 | 19,975 | 9,331 | 67.6 | `link_latency` | `a100_sxm_80gb-x112-tensor` | 192.3 | 127,378 | 2,916.2 | 0.999 | 22.43x | 43.1x |
| 32 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x111-romfill` | 90,465 | 1,211.2 | 38,760 | 128,909 | 10,295 | 265.6 | `link_latency` | `a100_sxm_80gb-x110-tensor` | 191.8 | 125,056 | 2,876.0 | 0.996 | 6.32x | 10.8x |
| 32 | wafer reference | `ROM-N6-native-HBMKV-wafer-hybrid-x2-romfill` | 92,450 | 4,312.9 | -- | 19,975 | -- | 67.6 | -- | -- | -- | -- | -- | 0.979 | 3.56x wafer/array | -- |
| 64 | array | `ROM-N6-native-HBMKV-array-hybrid-x56` | 45,640 | 1,230.1 | 78,728 | 65,035 | 4,964 | 63.0 | `link_latency` | `a100_sxm_80gb-x55-tensor` | 112.2 | 61,182 | 1,312.2 | 1.005 | 10.96x | 20.8x |
| 64 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x4-romfill` | 184,900 | 4,104.9 | 262,713 | 39,950 | 18,591 | 70.8 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 125.6 | 257,449 | 4,231.2 | 0.999 | 32.69x | 59.8x |
| 64 | array @ wafer area | `ROM-N6-native-HBMKV-array-hybrid-x227-romfill` | 185,005 | 1,163.1 | 74,436 | 158,175 | 19,448 | 261.3 | `link_latency` | `a100_sxm_80gb-x224-tensor` | 125.6 | 257,449 | 4,231.2 | 1.000 | 9.26x | 16.2x |
| 64 | wafer reference | `ROM-N6-native-HBMKV-wafer-hybrid-x4-romfill` | 184,900 | 4,104.9 | -- | 39,950 | -- | 70.8 | -- | -- | -- | -- | -- | 1.001 | 3.53x wafer/array | -- |
| 256 | array | `ROM-N6-native-HBMKV-array-hybrid-x227-romfill` | 185,005 | 1,040.2 | 266,290 | 158,175 | 20,441 | 76.8 | `link_latency` | `a100_sxm_80gb-x224-hybrid` | 42.4 | 257,449 | 3,403.5 | 1.000 | 24.53x | 44.3x |
| 256 | wafer | `ROM-N6-native-HBMKV-wafer-hybrid-x12-romfill` | 554,700 | 3,227.7 | 826,282 | 119,850 | 55,904 | 67.7 | `link_latency` | `a100_sxm_80gb-x672-tensor` | 39.5 | 777,732 | 9,653.6 | 0.999 | 81.63x | 142.7x |

**The best design differs by batch, and here is where it changes.**

| batches | design | mm2 | class | KV | resident sessions |
| --- | --- | ---: | --- | --- | ---: |
| 1-64 | `ROM-N6-native-HBMKV-wafer-tensor-x1` | 46,225 | wafer | HBM | 9,987 |
| 256 | `ROM-N6-native-HBMKV-wafer-hybrid-x2` | 92,450 | wafer | HBM | 19,975 |
...
- **0 of 2,008 feasible points (0.0%) are power-limited.**
- 0 points are uncoolable at any speed (static power alone at or above the cooling budget).

Nothing in this study is power-limited. That is a statement about these designs and not an artifact of the energy model: static power is charged per mm2 per second, so a design cannot escape it by moving fewer bytes. The busiest point reaches 77% of its cooling budget, and the busiest wafer-scale ROM design 30%. The companion study at the other node, whose HBM generation delivers more than twice the bandwidth per stack, does have power-limited points.

| Family | Area class | Points | Throttled | Median power / budget | Worst power / budget | Peak W/mm2 | Median static share |
|---|---|---:|---:|---:|---:|---:|---:|
| gpu | large array (5,000-40,000 mm2) | 144 | 0 | 47.8% | 57.6% | 0.279 | 75% |
| gpu | small array (1,600-5,000 mm2) | 16 | 0 | 73.9% | 77.0% | 0.373 | 49% |
| gpu | wafer (>=40,000 mm2) | 504 | 0 | 41.0% | 53.7% | 0.260 | 88% |
| rom | large array (5,000-40,000 mm2) | 162 | 0 | 15.5% | 20.8% | 0.104 | 98% |
| rom | wafer (>=40,000 mm2) | 1,182 | 0 | 20.2% | 30.2% | 0.151 | 99% |
...
|---|---:|---:|---|---:|---:|---|---|---:|---:|---|---:|
| DeepSeek-V4-Flash-0731 | 1 | 46,225 | `DSV4-Flash/ROM-N6-native-SRAMKV-wafer-tensor-x1` | 0.817887 | 3,850.5 | link_latency | `DSV4-Flash/a100_sxm_80gb-x56-tensor` | 12.362375 | 8,942.0 | link_latency | 15.12x |
| DeepSeek-V4-Flash-0731 | 2 | 46,225 | `DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1` | 0.426152 | 4,012.6 | link_latency | `DSV4-Flash/a100_sxm_80gb-x56-tensor` | 7.347608 | 9,034.3 | link_latency | 17.24x |
| DeepSeek-V4-Flash-0731 | 4 | 46,225 | `DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1` | 0.215716 | 4,062.3 | link_latency | `DSV4-Flash/a100_sxm_80gb-x56-tensor` | 4.638115 | 9,194.0 | link_latency | 21.50x |
| DeepSeek-V4-Flash-0731 | 8 | 46,225 | `DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1` | 0.110464 | 4,160.4 | link_latency | `DSV4-Flash/a100_sxm_80gb-x56-tensor` | 3.143860 | 9,405.8 | link_latency | 28.46x |
| DeepSeek-V4-Flash-0731 | 16 | 46,225 | `DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1` | 0.061966 | 4,322.4 | link_latency | `DSV4-Flash/a100_sxm_80gb-x56-tensor` | 2.277108 | 9,610.8 | link_latency | 36.75x |
| DeepSeek-V4-Flash-0731 | 32 | 92,450 | `DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x2-romfill` | 0.067611 | 9,331.1 | link_latency | `DSV4-Flash/a100_sxm_80gb-x112-tensor` | 2.916240 | 17,940.8 | link_latency | 43.13x |
| DeepSeek-V4-Flash-0731 | 64 | 138,675 | `DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x3-romfill` | 0.056478 | 14,211.9 | link_latency | `DSV4-Flash/a100_sxm_80gb-x168-tensor` | 3.275416 | 25,889.1 | link_latency | 57.99x |
| DeepSeek-V4-Flash-0731 | 256 | 369,800 | `DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x8-romfill` | 0.048259 | 38,454.6 | link_latency | `DSV4-Flash/a100_sxm_80gb-x448-tensor` | 6.470144 | 65,376.7 | link_latency | 134.07x |
...
|---|---:|---:|---:|---|---:|---|---:|---:|---|---:|---|---:|---:|---:|---:|
| DeepSeek-V4-Flash-0731 | 1 | 46,225 | 19,190.8 | wafer-pipeline | 4,707.9 | wafer-tensor | 4.08x | 1,587.3 | pipeline | 723.3 | tensor | 2.19x | 12.09x | 6.51x | 0.54x |
| DeepSeek-V4-Flash-0731 | 2 | 92,450 | 25,522.3 | wafer-pipeline | 4,423.3 | wafer-hybrid | 5.77x | 1,817.1 | pipeline | 764.0 | tensor | 2.38x | 14.05x | 5.79x | 0.41x |
| DeepSeek-V4-Flash-0731 | 3 | 138,675 | 31,249.4 | wafer-pipeline | 4,326.7 | wafer-hybrid | 7.22x | 1,913.7 | pipeline | 779.4 | tensor | 2.46x | 16.33x | 5.55x | 0.34x |
| DeepSeek-V4-Flash-0731 | 4 | 184,900 | 35,198.0 | wafer-pipeline | 4,234.1 | wafer-hybrid | 8.31x | 1,966.9 | pipeline | 787.4 | tensor | 2.50x | 17.90x | 5.38x | 0.30x |
| DeepSeek-V4-Flash-0731 | 6 | 277,350 | 40,288.3 | wafer-pipeline | 4,060.3 | wafer-hybrid | 9.92x | 2,023.9 | pipeline | 622.7 | tensor | 3.25x | 19.91x | 6.52x | 0.33x |
| DeepSeek-V4-Flash-0731 | 8 | 369,800 | 43,428.4 | wafer-pipeline | 3,900.3 | wafer-hybrid | 11.13x | 2,053.9 | pipeline | 625.4 | tensor | 3.28x | 21.14x | 6.24x | 0.29x |
| DeepSeek-V4-Flash-0731 | 12 | 554,700 | 47,008.4 | wafer-pipeline | 3,608.8 | wafer-hybrid | 13.03x | 2,085.1 | pipeline | 628.0 | tensor | 3.32x | 22.55x | 5.75x | 0.25x |
...
|---|---:|---|---|---:|---:|---:|---|---|---:|---:|---|---:|---:|---:|---|---:|---:|---:|---:|
| DeepSeek-V4-Flash-0731 | 1 | fastest | DSV4-Flash/ROM-N6-native-SRAMKV-wafer-tensor-x1 | 46,225 | 4,707.9 | 4,707.9 | link_latency | DSV4-Flash/a100_sxm_80gb-x56-tensor | 46,256 | 1.00x | tensor | 857.79 | 723.3 | 723.3 | link_latency | 6.51x | 6.51x | 135.62x | 6.51x |
| DeepSeek-V4-Flash-0731 | 1 | smallest silicon | DSV4-Flash/ROM-N6-native-SRAMKV-array-hybrid-x36 | 29,340 | 1,465.9 | 1,465.9 | link_latency | DSV4-Flash/a100_sxm_80gb-x36-tensor | 29,736 | 0.99x | tensor | 852.96 | 684.4 | 684.4 | link_latency | 2.14x | 2.14x | 31.58x | 2.14x |
| DeepSeek-V4-Flash-0731 | 2 | fastest | DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1 | 46,225 | 4,707.9 | 9,415.8 | link_latency | DSV4-Flash/a100_sxm_80gb-x56-tensor | 46,256 | 1.00x | tensor | 936.42 | 614.8 | 1,229.6 | link_latency | 7.66x | 7.66x | 135.62x | 7.66x |
| DeepSeek-V4-Flash-0731 | 2 | smallest silicon | DSV4-Flash/ROM-N6-native-HBMKV-array-hybrid-x39 | 31,785 | 1,495.9 | 7,479.5 | link_latency | DSV4-Flash/a100_sxm_80gb-x38-tensor | 31,388 | 1.01x | tensor | 926.76 | 580.9 | 1,161.8 | link_latency | 2.58x | 6.44x | 33.34x | 2.58x |
| DeepSeek-V4-Flash-0731 | 4 | fastest | DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1 | 46,225 | 4,707.9 | 18,831.6 | link_latency | DSV4-Flash/a100_sxm_80gb-x56-tensor | 46,256 | 1.00x | tensor | 1,093.67 | 495.6 | 1,982.3 | link_latency | 9.50x | 9.50x | 135.62x | 9.50x |
| DeepSeek-V4-Flash-0731 | 4 | smallest silicon | DSV4-Flash/ROM-N6-native-HBMKV-array-hybrid-x39 | 31,785 | 1,495.9 | 7,479.5 | link_latency | DSV4-Flash/a100_sxm_80gb-x38-tensor | 31,388 | 1.01x | tensor | 1,074.35 | 465.8 | 1,863.1 | link_latency | 3.21x | 4.01x | 33.34x | 3.21x |
| DeepSeek-V4-Flash-0731 | 8 | fastest | DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1 | 46,225 | 4,707.9 | 37,663.2 | link_latency | DSV4-Flash/a100_sxm_80gb-x56-tensor | 46,256 | 1.00x | tensor | 1,408.19 | 374.0 | 2,991.8 | link_latency | 12.59x | 12.59x | 135.62x | 12.59x |
| DeepSeek-V4-Flash-0731 | 8 | smallest silicon | DSV4-Flash/ROM-N6-native-HBMKV-array-hybrid-x39 | 31,785 | 1,251.1 | 10,009.0 | link_latency | DSV4-Flash/a100_sxm_80gb-x38-tensor | 31,388 | 1.01x | tensor | 1,369.54 | 348.5 | 2,788.3 | link_latency | 3.59x | 3.59x | 27.88x | 3.59x |
| DeepSeek-V4-Flash-0731 | 16 | fastest | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x2-romfill | 92,450 | 4,406.4 | 70,503.2 | link_latency | DSV4-Flash/a100_sxm_80gb-x112-tensor | 92,512 | 1.00x | tensor | 2,133.84 | 291.0 | 4,656.3 | link_latency | 15.14x | 15.14x | 214.03x | 15.14x |
| DeepSeek-V4-Flash-0731 | 16 | smallest silicon | DSV4-Flash/ROM-N6-native-HBMKV-array-hybrid-x39 | 31,785 | 871.0 | 13,936.7 | compute | DSV4-Flash/a100_sxm_80gb-x38-tensor | 31,388 | 1.01x | tensor | 1,959.92 | 244.7 | 3,914.7 | link_latency | 3.56x | 3.56x | 19.41x | 3.56x |
| DeepSeek-V4-Flash-0731 | 32 | fastest | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x2-romfill | 92,450 | 4,312.9 | 138,012.0 | link_latency | DSV4-Flash/a100_sxm_80gb-x112-tensor | 92,512 | 1.00x | tensor | 3,488.51 | 192.3 | 6,152.0 | link_latency | 22.43x | 22.43x | 209.49x | 22.43x |
| DeepSeek-V4-Flash-0731 | 32 | smallest silicon | DSV4-Flash/ROM-N6-native-HBMKV-array-pipeline-x39 | 31,785 | 571.5 | 22,289.6 | compute | DSV4-Flash/a100_sxm_80gb-x38-tensor | 31,388 | 1.01x | tensor | 3,140.68 | 163.7 | 5,238.8 | link_latency | 3.49x | 4.25x | 12.74x | 3.49x |
| DeepSeek-V4-Flash-0731 | 64 | fastest | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x4-romfill | 184,900 | 4,104.9 | 262,713.4 | link_latency | DSV4-Flash/a100_sxm_80gb-x224-tensor | 185,024 | 1.00x | tensor | 6,391.10 | 125.6 | 8,035.9 | link_latency | 32.69x | 32.69x | 359.76x | 32.69x |
| DeepSeek-V4-Flash-0731 | 64 | smallest silicon | DSV4-Flash/ROM-N6-native-HBMKV-array-pipeline-x39 | 31,785 | 356.7 | 22,827.3 | compute | DSV4-Flash/a100_sxm_80gb-x38-tensor | 31,388 | 1.01x | tensor | 5,502.21 | 106.8 | 6,832.2 | link_latency | 3.34x | 3.34x | 9.86x | 3.34x |
| DeepSeek-V4-Flash-0731 | 256 | fastest | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x12-romfill | 554,700 | 3,227.7 | 826,281.7 | link_latency | DSV4-Flash/a100_sxm_80gb-x672-tensor | 555,072 | 1.00x | tensor | 24,091.39 | 39.5 | 10,122.6 | link_latency | 81.63x | 81.63x | 785.37x | 81.63x |
| DeepSeek-V4-Flash-0731 | 256 | smallest silicon | DSV4-Flash/ROM-N6-native-HBMKV-array-pipeline-x39 | 31,785 | 91.8 | 23,490.4 | compute | DSV4-Flash/a100_sxm_80gb-x38-hybrid | 31,388 | 1.01x | hybrid | 820.85 | 53.4 | 13,675.2 | weight_read | 1.72x | 1.72x | 4.77x | 1.72x |
...
|---|---:|---:|---:|---:|---:|---|---:|---:|---|
| DeepSeek-V4-Flash-0731 | 3 | 2,478 | 127.6 | 327.4 | — | tensor | 434.70 | 14.2% | weight_read |
| DeepSeek-V4-Flash-0731 | 36 | 29,736 | 46.4 | 684.4 | 291.0 | tensor | 852.96 | 58.4% | link_latency |
| DeepSeek-V4-Flash-0731 | 37 | 30,562 | 45.6 | 687.3 | 293.6 | tensor | 852.96 | 58.6% | link_latency |
| DeepSeek-V4-Flash-0731 | 38 | 31,388 | 44.9 | 690.1 | 296.2 | tensor | 852.96 | 58.9% | link_latency |
| DeepSeek-V4-Flash-0731 | 39 | 32,214 | 44.1 | 692.8 | 298.6 | tensor | 852.96 | 59.1% | link_latency |
| DeepSeek-V4-Flash-0731 | 43 | 35,518 | 41.5 | 701.0 | 262.5 | tensor | 855.78 | 60.0% | link_latency |
| DeepSeek-V4-Flash-0731 | 46 | 37,996 | 39.7 | 707.4 | 267.8 | tensor | 855.78 | 60.5% | link_latency |
| DeepSeek-V4-Flash-0731 | 52 | 42,952 | 36.5 | 717.2 | 242.0 | tensor | 857.79 | 61.5% | link_latency |
| DeepSeek-V4-Flash-0731 | 55 | 45,430 | 35.1 | 721.9 | 245.8 | tensor | 857.79 | 61.9% | link_latency |
| DeepSeek-V4-Flash-0731 | 56 | 46,256 | 34.7 | 723.3 | 247.0 | tensor | 857.79 | 62.0% | link_latency |
| DeepSeek-V4-Flash-0731 | 69 | 56,994 | 29.9 | 737.6 | 207.8 | tensor | 860.47 | 63.5% | link_latency |
| DeepSeek-V4-Flash-0731 | 70 | 57,820 | 29.6 | 738.6 | 208.5 | tensor | 860.47 | 63.6% | link_latency |
| DeepSeek-V4-Flash-0731 | 73 | 60,298 | 28.7 | 740.9 | 191.3 | tensor | 861.41 | 63.8% | link_latency |
| DeepSeek-V4-Flash-0731 | 77 | 63,602 | 27.6 | 744.4 | 193.6 | tensor | 861.41 | 64.1% | link_latency |
| DeepSeek-V4-Flash-0731 | 82 | 67,732 | 26.3 | 748.0 | 179.9 | tensor | 862.18 | 64.5% | link_latency |
| DeepSeek-V4-Flash-0731 | 94 | 77,644 | 23.7 | 755.6 | 170.8 | tensor | 862.82 | 65.2% | link_latency |
| DeepSeek-V4-Flash-0731 | 104 | 85,904 | 21.8 | 760.6 | 161.7 | tensor | 863.36 | 65.7% | link_latency |
| DeepSeek-V4-Flash-0731 | 110 | 90,860 | 20.9 | 763.2 | 152.5 | tensor | 863.83 | 65.9% | link_latency |
| DeepSeek-V4-Flash-0731 | 111 | 91,686 | 20.7 | 763.6 | 152.8 | tensor | 863.83 | 66.0% | link_latency |
| DeepSeek-V4-Flash-0731 | 112 | 92,512 | 20.6 | 764.0 | 153.0 | tensor | 863.83 | 66.0% | link_latency |
| DeepSeek-V4-Flash-0731 | 138 | 113,988 | 17.3 | 772.5 | 125.1 | tensor | 865.17 | 66.8% | link_latency |
| DeepSeek-V4-Flash-0731 | 146 | 120,596 | 16.5 | 774.5 | 119.9 | tensor | 865.42 | 67.0% | link_latency |
| DeepSeek-V4-Flash-0731 | 168 | 138,768 | 14.7 | 779.4 | 111.1 | tensor | 865.84 | 67.5% | link_latency |
...
| DeepSeek-V4-Flash-0731 | 448 | 370,048 | 6.0 | 625.4 | 47.1 | tensor | 1,217.52 | 76.1% | link_latency |
...
| DSV4-Flash/a100_sxm_80gb-x3-pipeline | DeepSeek-V4-Flash-0731 | 3 | pipeline | nvlink3 | infiniband_hdr | 2 | 5.05 us | 19,783.9 tok/s | 197,839.1 tok/s | 2 x point_to_point span 2 on nvlink3 (traversals 1.0) = 5.05 us |
| DSV4-Flash/a100_sxm_80gb-x3-tensor | DeepSeek-V4-Flash-0731 | 3 | tensor | nvlink3 | infiniband_hdr | 86 | 434.70 us | 230.0 tok/s | 2,300.5 tok/s | 86 x all_reduce span 3 on nvlink3 (traversals 2.0) = 434.70 us |
...
| DSV4-Flash/a100_sxm_80gb-x94-pipeline | DeepSeek-V4-Flash-0731 | 94 | pipeline | nvlink3 | infiniband_hdr | 42 | 105.30 us | 949.7 tok/s | 9,496.8 tok/s | 37 x point_to_point span 2 on nvlink3 (traversals 1.0) = 93.51 us; 5 x point_to_point span 2 on infiniband_hdr (traversals 1.0) = 11.79 us |
| DSV4-Flash/a100_sxm_80gb-x94-tensor | DeepSeek-V4-Flash-0731 | 94 | tensor | nvlink3 | infiniband_hdr | 172 | 862.82 us | 115.9 tok/s | 1,159.0 tok/s | 86 x all_reduce span 8 on nvlink3 (traversals 2.0) = 436.16 us; 86 x all_reduce span 12 on infiniband_hdr (traversals 2.0) = 426.66 us |
| DSV4-Flash/a100_sxm_80gb-x94-hybrid | DeepSeek-V4-Flash-0731 | 94 | hybrid | nvlink3 | infiniband_hdr | 97 | 462.10 us | 216.4 tok/s | 2,164.0 tok/s | 86 x all_reduce span 8 on nvlink3 (traversals 2.0) = 436.16 us; 11 x point_to_point span 2 on infiniband_hdr (traversals 1.0) = 25.93 us |
...
|---|---:|---|---|---|---:|---:|---:|---:|---:|---:|---|
| DeepSeek-V4-Flash-0731 | 1 | wafer | wafer | DSV4-Flash/ROM-N6-native-SRAMKV-wafer-tensor-x1 | 46,225 | 4,707.9 | 0.102 | 1,465.9 (29,340) | 4,707.9 (46,225) | 3.21x | link_latency |
| DeepSeek-V4-Flash-0731 | 2 | wafer | wafer | DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1 | 46,225 | 4,707.9 | 0.102 | 1,495.9 (31,785) | 4,707.9 (46,225) | 3.15x | link_latency |
| DeepSeek-V4-Flash-0731 | 4 | wafer | wafer | DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1 | 46,225 | 4,707.9 | 0.102 | 1,495.9 (31,785) | 4,707.9 (46,225) | 3.15x | link_latency |
| DeepSeek-V4-Flash-0731 | 8 | wafer | wafer | DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1 | 46,225 | 4,707.9 | 0.102 | 1,455.3 (32,600) | 4,707.9 (46,225) | 3.23x | link_latency |
| DeepSeek-V4-Flash-0731 | 16 | wafer | wafer | DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1 | 46,225 | 4,359.7 | 0.094 | 1,422.2 (38,305) | 4,359.7 (46,225) | 3.07x | link_latency |
| DeepSeek-V4-Flash-0731 | 32 | wafer | wafer | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x2-romfill | 92,450 | 4,312.9 | 0.047 | 1,309.0 (38,305) | 4,312.9 (92,450) | 3.29x | link_latency |
| DeepSeek-V4-Flash-0731 | 64 | wafer | wafer | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x3-romfill | 138,675 | 3,931.8 | 0.028 | 1,230.1 (45,640) | 3,931.8 (138,675) | 3.20x | link_latency |
| DeepSeek-V4-Flash-0731 | 256 | wafer | wafer | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x8-romfill | 369,800 | 3,112.6 | 0.008 | 1,025.6 (120,620) | 3,112.6 (369,800) | 3.03x | link_latency |
...
| DeepSeek-V4-Flash-0731 | 16 | sram | 69,754.9 | 26,008.0 | 46,137.9 | 2.68x | 1.77x | link_latency | weight_read | link_latency |
| DeepSeek-V4-Flash-0731 | 32 | sram | 122,884.3 | 26,008.0 | 79,080.0 | 4.72x | 3.04x | link_latency | weight_read | weight_read |
| DeepSeek-V4-Flash-0731 | 64 | sram | 244,945.4 | 26,008.0 | 129,804.8 | 9.42x | 4.99x | link_latency | weight_read | weight_read |
| DeepSeek-V4-Flash-0731 | 256 | sram | 717,864.9 | 26,066.2 | 296,340.9 | 27.54x | 11.37x | link_latency | weight_read | weight_read |
...
| DeepSeek-V4-Flash-0731 | 256 | rom | 826,281.7 | 41,482.0 | 417,637.7 | 19.92x | 10.07x | link_latency | weight_read | weight_read |
...
| DeepSeek-V4-Flash-0731 | 16 | batched | sram | DSV4-Flash/ROM-N6-native-HBMKV-wafer-tensor-x1 | 46,225 | 1.00 | 1.00 | 69,754.9 | 1.509 | link_latency | 1.00x |
| DeepSeek-V4-Flash-0731 | 16 | batched | rom | DSV4-Flash/ROM-N6-native-HBMKV-wafer-pipeline-x12-romfill | 554,700 | 10.55 | 1.00 | 273,531.4 | 0.493 | weight_read | 3.92x |
| DeepSeek-V4-Flash-0731 | 16 | per_stream | sram | DSV4-Flash/ROM-N6-native-SRAMKV-wafer-pipeline-x2-perstream | 92,450 | 1.00 | 1.00 | 26,008.0 | 0.281 | weight_read | 0.37x |
| DeepSeek-V4-Flash-0731 | 16 | per_stream | rom | DSV4-Flash/ROM-N6-native-HBMKV-wafer-pipeline-x2-perstream-romfill | 92,450 | 1.59 | 1.00 | 41,334.8 | 0.447 | weight_read | 0.59x |
| DeepSeek-V4-Flash-0731 | 16 | per_region | sram | DSV4-Flash/ROM-N6-native-SRAMKV-wafer-hybrid-x2-perregion | 92,450 | 1.00 | 2.13 | 46,137.9 | 0.499 | link_latency | 0.66x |
| DeepSeek-V4-Flash-0731 | 16 | per_region | rom | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x2-perregion-romfill | 92,450 | 1.59 | 2.13 | 55,953.6 | 0.605 | link_latency | 0.80x |
...
| DeepSeek-V4-Flash-0731 | 64 | batched | sram | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x2 | 92,450 | 1.00 | 1.00 | 244,945.4 | 2.649 | link_latency | 1.00x |
| DeepSeek-V4-Flash-0731 | 64 | batched | rom | DSV4-Flash/ROM-N6-native-HBMKV-wafer-pipeline-x12-romfill | 554,700 | 10.55 | 1.00 | 273,531.4 | 0.493 | weight_read | 1.12x |
| DeepSeek-V4-Flash-0731 | 64 | per_stream | sram | DSV4-Flash/ROM-N6-native-SRAMKV-wafer-pipeline-x2-perstream | 92,450 | 1.00 | 1.00 | 26,008.0 | 0.281 | weight_read | 0.11x |
| DeepSeek-V4-Flash-0731 | 64 | per_stream | rom | DSV4-Flash/ROM-N6-native-HBMKV-wafer-pipeline-x2-perstream-romfill | 92,450 | 1.59 | 1.00 | 41,334.8 | 0.447 | weight_read | 0.17x |
| DeepSeek-V4-Flash-0731 | 64 | per_region | sram | DSV4-Flash/ROM-N6-native-SRAMKV-wafer-hybrid-x2-perregion | 92,450 | 1.00 | 4.03 | 129,804.8 | 1.404 | weight_read | 0.53x |
| DeepSeek-V4-Flash-0731 | 64 | per_region | rom | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x2-perregion-romfill | 92,450 | 1.59 | 4.03 | 169,200.5 | 1.830 | weight_read | 0.69x |
| DeepSeek-V4-Flash-0731 | 256 | batched | sram | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x4 | 184,900 | 1.00 | 1.00 | 717,864.9 | 3.882 | link_latency | 1.00x |
| DeepSeek-V4-Flash-0731 | 256 | batched | rom | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x12-romfill | 554,700 | 10.55 | 1.00 | 826,281.7 | 1.490 | link_latency | 1.15x |
| DeepSeek-V4-Flash-0731 | 256 | per_stream | sram | DSV4-Flash/ROM-N6-native-SRAMKV-wafer-pipeline-x2-perstream | 92,450 | 1.00 | 2.25 | 26,066.2 | 0.282 | weight_read | 0.04x |
| DeepSeek-V4-Flash-0731 | 256 | per_stream | rom | DSV4-Flash/ROM-N6-native-HBMKV-wafer-pipeline-x2-perstream-romfill | 92,450 | 1.59 | 2.25 | 41,482.0 | 0.449 | weight_read | 0.06x |
| DeepSeek-V4-Flash-0731 | 256 | per_region | sram | DSV4-Flash/ROM-N6-native-SRAMKV-wafer-hybrid-x2-perregion | 92,450 | 1.00 | 8.80 | 296,340.9 | 3.205 | weight_read | 0.41x |
| DeepSeek-V4-Flash-0731 | 256 | per_region | rom | DSV4-Flash/ROM-N6-native-HBMKV-wafer-hybrid-x2-perregion-romfill | 92,450 | 1.59 | 8.80 | 417,637.7 | 4.517 | weight_read | 0.58x |
...
| DeepSeek-V4-Flash-0731 | 8 | 71 | 1.00 | 1.000 | 1.000 | 1.00x |
| DeepSeek-V4-Flash-0731 | 16 | 71 | 1.00 | 1.000 | 1.000 | 1.00x |
...
| DeepSeek-V4-Flash-0731 | 2 | 3 | 2.74 | 2.02 | 1.35x |
| DeepSeek-V4-Flash-0731 | 4 | 3 | 2.88 | 2.11 | 1.37x |
| DeepSeek-V4-Flash-0731 | 8 | 3 | 2.99 | 2.30 | 1.30x |
| DeepSeek-V4-Flash-0731 | 16 | 3 | 3.00 | 2.46 | 1.22x |
| DeepSeek-V4-Flash-0731 | 32 | 3 | 3.00 | 2.59 | 1.16x |
| DeepSeek-V4-Flash-0731 | 64 | 3 | 3.00 | 2.68 | 1.12x |
| DeepSeek-V4-Flash-0731 | 256 | 3 | 3.00 | 2.78 | 1.08x |
...
| DeepSeek-V4-Flash-0731 | 1 | 94 | 5.84 | 5.25 | 1.11x |
| DeepSeek-V4-Flash-0731 | 2 | 94 | 5.84 | 5.25 | 1.11x |
| DeepSeek-V4-Flash-0731 | 4 | 94 | 5.84 | 5.25 | 1.11x |
| DeepSeek-V4-Flash-0731 | 8 | 94 | 5.84 | 5.25 | 1.11x |
| DeepSeek-V4-Flash-0731 | 16 | 94 | 5.84 | 5.25 | 1.11x |
| DeepSeek-V4-Flash-0731 | 32 | 94 | 5.84 | 5.25 | 1.11x |
| DeepSeek-V4-Flash-0731 | 64 | 94 | 5.84 | 5.25 | 1.11x |
| DeepSeek-V4-Flash-0731 | 256 | 94 | 14.80 | 9.17 | 1.61x |
...
|---|---:|---:|---:|---:|---:|
| DeepSeek-V4-Flash-0731 | 1 | 71 | 4.75% | 14.65 | 4.34 |
| DeepSeek-V4-Flash-0731 | 2 | 71 | 4.75% | 14.65 | 4.34 |
| DeepSeek-V4-Flash-0731 | 4 | 71 | 4.75% | 14.65 | 4.34 |
| DeepSeek-V4-Flash-0731 | 8 | 71 | 4.75% | 14.65 | 4.34 |
| DeepSeek-V4-Flash-0731 | 16 | 71 | 4.75% | 14.65 | 4.34 |
| DeepSeek-V4-Flash-0731 | 32 | 2 | 0.09% | 0.45 | 4.34 |
| DeepSeek-V4-Flash-0731 | 64 | 2 | 0.09% | 0.45 | 4.34 |
| DeepSeek-V4-Flash-0731 | 256 | 2 | 0.21% | 1.01 | 4.34 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| DeepSeek-V4-Flash-0731 | 1 | 2.34% | 11.2 GB | 6.72% | 325.47 TB/s | 4,841.92 TB/s | 571.5 | 22,289.6 |
| DeepSeek-V4-Flash-0731 | 2 | 2.34% | 11.2 GB | 6.72% | 325.47 TB/s | 4,841.92 TB/s | 571.5 | 22,289.6 |
| DeepSeek-V4-Flash-0731 | 4 | 2.34% | 11.2 GB | 6.72% | 325.47 TB/s | 4,841.92 TB/s | 571.5 | 22,289.6 |
| DeepSeek-V4-Flash-0731 | 8 | 2.34% | 11.2 GB | 6.72% | 325.47 TB/s | 4,841.92 TB/s | 571.5 | 22,289.6 |
| DeepSeek-V4-Flash-0731 | 16 | 2.34% | 11.2 GB | 6.72% | 325.47 TB/s | 4,841.92 TB/s | 571.5 | 22,289.6 |
| DeepSeek-V4-Flash-0731 | 32 | 2.34% | 11.2 GB | 6.72% | 325.47 TB/s | 4,841.92 TB/s | 571.5 | 22,289.6 |
| DeepSeek-V4-Flash-0731 | 64 | 3.82% | 13.4 GB | 8.02% | 388.39 TB/s | 4,841.92 TB/s | 356.7 | 22,827.3 |
| DeepSeek-V4-Flash-0731 | 256 | 14.42% | 29.0 GB | 17.37% | 840.99 TB/s | 4,841.92 TB/s | 91.8 | 23,490.4 |
