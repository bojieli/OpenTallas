...
6. **Letting the GPU choose its own parallelism is worth up to 97.29x to it.** At 554,700 mm2 on DeepSeek-V4-Pro-0813 the pipeline-only GPU delivers 8.10 tok/s and the same silicon running tensor delivers 788 tok/s.
7. **The advantage erodes with batch, and the erosion is a KV effect.** At batch 256 the aggregate ratio at equal area spans 0.46x (DeepSeek-V4-Pro-0813, ROM binding on `link_latency`) to 54.73x (DeepSeek-V4-Pro-0813, ROM binding on `link_latency`). Weight traffic is what ROM removes; KV traffic it does not, and KV traffic is what grows with batch.
8. **Sparse MoE buys aggregate throughput on a ROM machine, not latency.** DeepSeek-V4-Pro-0813 engages 4.4% of its ROM array at batch 1 and 5.3% at batch 256, while the weight-read time is identical at both. What the machine delivers rises from 123 to 19,562 tok/s, and its rate with every slot occupied from 19,474 to 19,562. The second rises far less than the first because the batch-1 figure is already a full-machine number -- this design has 158 slots -- so most of what batching adds there is coverage rather than occupancy. An unselected expert's read ports cannot be borrowed, so its idle bandwidth is only recovered by giving the sweep more users.
...
11. **A wafer has less die edge per unit area than the same area of separate dies, and that is an argument against it.** Perimeter grows as the square root of area, so HBM beachfront -- and therefore KV bandwidth -- does not scale with wafer area the way compute and ROM capacity do. This model charges both sides the same edge utilisation a shipping GPU achieves, and the consequence shows up wherever a design binds on `kv_read`: 0 of 1444 feasible points.
12. **The largest open question is not in this model's inputs but in the architecture, and a batch-1 anchor cannot settle its scaling law.** If a ROM cell both stores and multiplies, each concurrent stream needs its own pass and aggregate per-die throughput never exceeds the per-user rate. At batch 256 that costs up to 17.9x of aggregate throughput (DeepSeek-V4-Pro-0813). Their sweep counts coincide at batch 1, but their cell and pre-compute costs make their floorplans different; the current compute-in-ROM anchor reconstruction fails capacity. A batch-1 validation therefore cannot establish either high-batch law.
...
- 7,946 tok/s aggregate with every slot full, over 7,899 resident sessions (fill limited by `pipeline_slots`)
- 8,746 W at 0.063 W/mm2, 1,100.7 mJ/token, thermal scale 1.000
...
| resident sessions | 7,899 | 39,919 | -- |
| J/token | 1.1007 | 44.9002 | 40.8x |

The areas match to within 2%, so no granularity correction is needed on this row.

**Read the resident-session row before the ratio row.** A per-user rate divided by a per-user rate is a latency claim, and a latency claim taken from a machine that holds 7,899 sessions against one that holds 39,919 is not the trade it looks like. Where those two numbers are far apart the honest reading is the batch-regime table below, not this row.
...
| smallest feasible machine | `ROM-N5-native-SRAMKV-array-tensor-x146` | 118,990 | 1,035.8 | 8.7 | 1 | 1.40x |
| **after -- this report's rule** | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | 2,648.8 | 19.1 | 7,899 | 3.54x |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | --- | ---: |
| `ROM-N5-native-HBMKV-wafer-hybrid-x3` **<-- recommended** | 138,675 | 3 | 2,648.8 | 7,946 | 19.1 | 7,899 | `link_latency` | 8,746 | 1,100.7 | `b200_sxm-x87-tensor` | 3.54x |
...
| array | 96 | smallest | `ROM-N5-native-SRAMKV-array-tensor-x146` | 118,990 | 1,035.8 | 8.7 | 1 |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | array | `ROM-N5-native-SRAMKV-array-tensor-x340-romfill` | 277,100 | 1,062.6 | 1,063 | 1 | 23,682 | 22,285.8 | `link_latency` | `b200_sxm-x173-tensor` | 774.1 | 82,049 | 82,507.4 | 1.001 | 1.37x | 3.7x |
| 1 | wafer | `ROM-N5-native-SRAMKV-wafer-hybrid-x3` | 138,675 | 2,648.8 | 2,649 | 1 | 8,193 | 3,093.1 | `link_latency` | `b200_sxm-x87-tensor` | 748.9 | 39,919 | 44,900.2 | 0.996 | 3.54x | 14.5x |
| 1 | array @ wafer area | `ROM-N5-native-SRAMKV-array-tensor-x170` | 138,550 | 1,053.4 | 1,053 | 1 | 8,518 | 8,086.2 | `link_latency` | `b200_sxm-x87-tensor` | 748.9 | 39,919 | 44,900.2 | 0.995 | 1.41x | 5.6x |
| 1 | wafer reference | `ROM-N5-native-SRAMKV-wafer-hybrid-x3` | 138,675 | 2,648.8 | -- | 1 | -- | 3,093.1 | -- | -- | -- | -- | -- | 0.999 | 2.51x wafer/array | -- |
| 2 | array | `ROM-N5-native-HBMKV-array-tensor-x340-romfill` | 277,100 | 952.4 | 1,905 | 62,459 | 27,312 | 14,337.9 | `link_latency` | `b200_sxm-x173-tensor` | 678.7 | 82,049 | 47,428.7 | 1.001 | 1.40x | 3.3x |
| 2 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | 2,648.8 | 7,946 | 7,899 | 8,746 | 1,100.7 | `link_latency` | `b200_sxm-x87-tensor` | 641.3 | 39,919 | 26,537.0 | 0.996 | 4.13x | 24.1x |
| 2 | array @ wafer area | `ROM-N5-native-HBMKV-array-tensor-x170` | 138,550 | 948.3 | 1,897 | 52,049 | 10,566 | 5,571.4 | `link_latency` | `b200_sxm-x87-tensor` | 641.3 | 39,919 | 26,537.0 | 0.995 | 1.48x | 4.8x |
| 2 | wafer reference | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | 2,648.8 | -- | 7,899 | -- | 1,100.7 | -- | -- | -- | -- | -- | 0.999 | 2.79x wafer/array | -- |
| 4 | array | `ROM-N5-native-HBMKV-array-hybrid-x160` | 130,400 | 888.6 | 17,771 | 48,987 | 9,705 | 546.1 | `weight_read` | `b200_sxm-x82-tensor` | 507.1 | 37,470 | 16,208.5 | 0.994 | 1.75x | 29.7x |
| 4 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | 2,648.3 | 10,593 | 7,899 | 8,800 | 830.7 | `link_latency` | `b200_sxm-x87-tensor` | 510.5 | 39,919 | 16,972.2 | 0.996 | 5.19x | 20.4x |
| 4 | array @ wafer area | `ROM-N5-native-HBMKV-array-hybrid-x170` | 138,550 | 828.7 | 18,232 | 52,049 | 11,040 | 605.5 | `weight_read` | `b200_sxm-x87-tensor` | 510.5 | 39,919 | 16,972.2 | 0.995 | 1.62x | 28.0x |
| 4 | wafer reference | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | 2,648.3 | -- | 7,899 | -- | 830.7 | -- | -- | -- | -- | -- | 0.999 | 3.20x wafer/array | -- |
| 8 | array | `ROM-N5-native-HBMKV-array-hybrid-x160` | 130,400 | 888.6 | 17,771 | 48,987 | 9,705 | 546.1 | `weight_read` | `b200_sxm-x82-tensor` | 378.5 | 37,470 | 11,140.7 | 0.994 | 2.35x | 20.4x |
| 8 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | 2,646.5 | 21,172 | 7,899 | 9,012 | 425.7 | `link_latency` | `b200_sxm-x87-tensor` | 381.8 | 39,919 | 11,632.2 | 0.996 | 6.93x | 27.3x |
| 8 | array @ wafer area | `ROM-N5-native-HBMKV-array-hybrid-x170` | 138,550 | 828.7 | 18,232 | 52,049 | 11,040 | 605.5 | `weight_read` | `b200_sxm-x87-tensor` | 381.8 | 39,919 | 11,632.2 | 0.995 | 2.17x | 19.2x |
| 8 | wafer reference | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | 2,646.5 | -- | 7,899 | -- | 425.7 | -- | -- | -- | -- | -- | 0.999 | 3.19x wafer/array | -- |
| 16 | array | `ROM-N5-native-HBMKV-array-hybrid-x160` | 130,400 | 888.6 | 17,771 | 48,987 | 9,705 | 546.1 | `weight_read` | `b200_sxm-x82-tensor` | 260.1 | 37,470 | 8,301.7 | 0.994 | 3.42x | 15.2x |
| 16 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | 2,619.5 | 41,912 | 7,899 | 9,427 | 224.9 | `link_latency` | `b200_sxm-x87-tensor` | 262.6 | 39,919 | 8,654.0 | 0.996 | 9.98x | 38.5x |
| 16 | array @ wafer area | `ROM-N5-native-HBMKV-array-hybrid-x170` | 138,550 | 828.7 | 18,232 | 52,049 | 11,040 | 605.5 | `weight_read` | `b200_sxm-x87-tensor` | 262.6 | 39,919 | 8,654.0 | 0.995 | 3.16x | 14.3x |
| 16 | wafer reference | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | 2,619.5 | -- | 7,899 | -- | 224.9 | -- | -- | -- | -- | -- | 0.999 | 3.16x wafer/array | -- |
| 32 | array | `ROM-N5-native-HBMKV-array-hybrid-x170` | 138,550 | 825.3 | 26,409 | 52,049 | 11,205 | 424.3 | `weight_read` | `b200_sxm-x87-tensor` | 168.1 | 39,919 | 6,844.4 | 0.995 | 4.91x | 16.1x |
| 32 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,364.4 | 75,662 | 10,532 | 16,935 | 223.8 | `link_latency` | `b200_sxm-x116-tensor` | 172.7 | 54,126 | 8,529.3 | 0.996 | 13.69x | 38.1x |
| 32 | array @ wafer area | `ROM-N5-native-HBMKV-array-hybrid-x227` | 185,005 | 670.1 | 21,444 | 69,501 | 18,649 | 869.7 | `weight_read` | `b200_sxm-x116-tensor` | 172.7 | 54,126 | 8,529.3 | 0.997 | 3.88x | 9.8x |
| 32 | wafer reference | `ROM-N5-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,364.4 | -- | 10,532 | -- | 223.8 | -- | -- | -- | -- | -- | 1.001 | 3.53x wafer/array | -- |
| 64 | array | `ROM-N5-native-HBMKV-array-hybrid-x170` | 138,550 | 814.4 | 52,122 | 52,049 | 11,720 | 224.9 | `weight_read` | `b200_sxm-x87-tensor` | 101.9 | 39,919 | 5,594.8 | 0.995 | 7.99x | 24.9x |
| 64 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,351.7 | 150,508 | 10,532 | 18,399 | 122.2 | `link_latency` | `b200_sxm-x116-tensor` | 104.0 | 54,126 | 7,029.9 | 0.996 | 22.62x | 57.5x |
| 64 | array @ wafer area | `ROM-N5-native-HBMKV-array-hybrid-x227` | 185,005 | 663.7 | 42,475 | 69,501 | 19,071 | 449.0 | `weight_read` | `b200_sxm-x116-tensor` | 104.0 | 54,126 | 7,029.9 | 0.997 | 6.38x | 15.7x |
| 64 | wafer reference | `ROM-N5-native-HBMKV-wafer-hybrid-x4` | 184,900 | 2,351.7 | -- | 10,532 | -- | 122.2 | -- | -- | -- | -- | -- | 1.001 | 3.54x wafer/array | -- |
| 256 | array | `ROM-N5-native-HBMKV-array-hybrid-x227` | 185,005 | 627.5 | 160,633 | 69,501 | 21,416 | 133.3 | `weight_read` | `b200_sxm-x116-hybrid` | 50.9 | 54,126 | 4,493.7 | 0.997 | 12.32x | 33.7x |
| 256 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x12-romfill` | 554,700 | 1,991.3 | 509,784 | 31,597 | 59,414 | 116.5 | `link_latency` | `b200_sxm-x347-hybrid` | 36.4 | 167,288 | 14,859.7 | 0.999 | 54.73x | 127.5x |

**The best design differs by batch, and here is where it changes.**

| batches | design | mm2 | class | KV | resident sessions |
| --- | --- | ---: | --- | --- | ---: |
| 1-32 | `ROM-N5-native-HBMKV-wafer-hybrid-x3` | 138,675 | wafer | HBM | 7,899 |
| 64 | `ROM-N5-native-HBMKV-wafer-hybrid-x4` | 184,900 | wafer | HBM | 10,532 |
| 256 | `ROM-N5-native-HBMKV-wafer-hybrid-x6` | 277,350 | wafer | HBM | 15,798 |
...
| --- | --- | --- | --- |
| DeepSeek-V4-Pro-0813 | HBM | rom | 158, 160, 170, 193, 227, 231, 308, 340 |
| DeepSeek-V4-Pro-0813 | HBM | sram | 158, 160, 170, 193, 227, 231, 308, 340 |
...
- **0 of 1,444 feasible points (0.0%) are power-limited.**
- 0 points are uncoolable at any speed (static power alone at or above the cooling budget).

Nothing in this study is power-limited. That is a statement about these designs and not an artifact of the energy model: static power is charged per mm2 per second, so a design cannot escape it by moving fewer bytes. The busiest point reaches 91% of its cooling budget, and the busiest wafer-scale ROM design 28%. The companion study at the other node, whose HBM generation delivers more than twice the bandwidth per stack, does have power-limited points.

| Family | Area class | Points | Throttled | Median power / budget | Worst power / budget | Peak W/mm2 | Median static share |
|---|---|---:|---:|---:|---:|---:|---:|
| gpu | large array (5,000-40,000 mm2) | 16 | 0 | 81.4% | 90.8% | 0.567 | 43% |
| gpu | wafer (>=40,000 mm2) | 456 | 0 | 42.4% | 74.1% | 0.463 | 83% |
| rom | wafer (>=40,000 mm2) | 972 | 0 | 16.5% | 27.6% | 0.138 | 98% |
...
|---|---:|---:|---|---:|---:|---|---|---:|---:|---|---:|
| DeepSeek-V4-Pro-0813 | 1 | 138,675 | `DSV4-Pro/ROM-N5-native-SRAMKV-wafer-hybrid-x3` | 3.093120 | 8,193.0 | link_latency | `DSV4-Pro/b200_sxm-x87-tensor` | 44.900216 | 33,624.5 | link_latency | 14.52x |
| DeepSeek-V4-Pro-0813 | 2 | 138,675 | `DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3` | 1.100658 | 8,746.2 | link_latency | `DSV4-Pro/b200_sxm-x87-tensor` | 26.536967 | 34,038.4 | link_latency | 24.11x |
| DeepSeek-V4-Pro-0813 | 4 | 138,675 | `DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3` | 0.830675 | 8,799.6 | link_latency | `DSV4-Pro/b200_sxm-x87-tensor` | 16.972208 | 34,658.5 | link_latency | 20.43x |
| DeepSeek-V4-Pro-0813 | 8 | 138,675 | `DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3` | 0.425674 | 9,012.5 | link_latency | `DSV4-Pro/b200_sxm-x87-tensor` | 11.632189 | 35,526.0 | link_latency | 27.33x |
| DeepSeek-V4-Pro-0813 | 16 | 138,675 | `DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3` | 0.224917 | 9,426.8 | link_latency | `DSV4-Pro/b200_sxm-x87-tensor` | 8.653981 | 36,360.5 | link_latency | 38.48x |
| DeepSeek-V4-Pro-0813 | 32 | 184,900 | `DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x4` | 0.223826 | 16,935.2 | link_latency | `DSV4-Pro/b200_sxm-x116-tensor` | 8.529333 | 47,149.4 | link_latency | 38.11x |
| DeepSeek-V4-Pro-0813 | 64 | 184,900 | `DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x4` | 0.122246 | 18,398.9 | link_latency | `DSV4-Pro/b200_sxm-x116-tensor` | 7.029927 | 46,771.6 | link_latency | 57.51x |
| DeepSeek-V4-Pro-0813 | 256 | 554,700 | `DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x12-romfill` | 0.116548 | 59,414.2 | link_latency | `DSV4-Pro/b200_sxm-x347-hybrid` | 14.859713 | 138,398.9 | weight_read | 127.50x |
...
|---|---:|---:|---:|---|---:|---|---:|---:|---|---:|---|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 3 | 138,675 | 14,625.7 | wafer-pipeline | 2,648.8 | wafer-hybrid | 5.52x | 1,896.2 | pipeline | 748.9 | tensor | 2.53x | 7.71x | 3.54x | 0.46x |
| DeepSeek-V4-Pro-0813 | 4 | 184,900 | 14,625.7 | wafer-pipeline | 2,375.7 | wafer-hybrid | 6.16x | 1,986.5 | pipeline | 761.1 | tensor | 2.61x | 7.36x | 3.12x | 0.42x |
| DeepSeek-V4-Pro-0813 | 6 | 277,350 | 17,307.6 | wafer-pipeline | 2,251.6 | wafer-hybrid | 7.69x | 2,087.2 | pipeline | 774.1 | tensor | 2.70x | 8.29x | 2.91x | 0.35x |
| DeepSeek-V4-Pro-0813 | 8 | 369,800 | 19,665.2 | wafer-pipeline | 2,201.1 | wafer-hybrid | 8.93x | 2,143.7 | pipeline | 781.0 | tensor | 2.74x | 9.17x | 2.82x | 0.31x |
| DeepSeek-V4-Pro-0813 | 12 | 554,700 | 22,765.9 | wafer-pipeline | 2,106.7 | wafer-hybrid | 10.81x | 2,204.0 | pipeline | 788.1 | tensor | 2.80x | 10.33x | 2.67x | 0.26x |
...
|---|---:|---|---|---:|---:|---:|---|---|---:|---:|---|---:|---:|---:|---|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 1 | fastest | DSV4-Pro/ROM-N5-native-SRAMKV-wafer-hybrid-x3 | 138,675 | 2,648.8 | 2,648.8 | link_latency | DSV4-Pro/b200_sxm-x87-tensor | 139,200 | 1.00x | tensor | 888.62 | 748.9 | 748.9 | link_latency | 3.54x | 3.54x | 99.15x | 3.54x |
| DeepSeek-V4-Pro-0813 | 1 | smallest silicon | DSV4-Pro/ROM-N5-native-SRAMKV-array-tensor-x146 | 118,990 | 1,035.8 | 1,035.8 | link_latency | DSV4-Pro/b200_sxm-x74-tensor | 118,400 | 1.00x | tensor | 887.67 | 740.2 | 740.2 | link_latency | 1.40x | 1.40x | 34.26x | 1.40x |
| DeepSeek-V4-Pro-0813 | 2 | fastest | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3 | 138,675 | 2,648.8 | 7,946.3 | link_latency | DSV4-Pro/b200_sxm-x87-tensor | 139,200 | 1.00x | tensor | 989.12 | 641.3 | 1,282.7 | link_latency | 4.13x | 6.20x | 99.15x | 4.13x |
| DeepSeek-V4-Pro-0813 | 2 | smallest silicon | DSV4-Pro/ROM-N5-native-HBMKV-array-tensor-x158 | 128,770 | 895.4 | 1,790.9 | link_latency | DSV4-Pro/b200_sxm-x80-tensor | 128,000 | 1.01x | tensor | 987.21 | 636.1 | 1,272.2 | link_latency | 1.41x | 1.41x | 31.42x | 1.41x |
| DeepSeek-V4-Pro-0813 | 4 | fastest | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3 | 138,675 | 2,648.3 | 10,593.3 | link_latency | DSV4-Pro/b200_sxm-x87-tensor | 139,200 | 1.00x | tensor | 1,190.12 | 510.5 | 2,042.1 | link_latency | 5.19x | 5.19x | 99.13x | 5.19x |
| DeepSeek-V4-Pro-0813 | 4 | smallest silicon | DSV4-Pro/ROM-N5-native-HBMKV-array-hybrid-x158 | 128,770 | 727.8 | 14,555.0 | compute | DSV4-Pro/b200_sxm-x80-tensor | 128,000 | 1.01x | tensor | 1,186.31 | 506.7 | 2,026.6 | link_latency | 1.44x | 7.18x | 25.54x | 1.44x |
| DeepSeek-V4-Pro-0813 | 8 | fastest | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3 | 138,675 | 2,646.5 | 21,172.3 | link_latency | DSV4-Pro/b200_sxm-x87-tensor | 139,200 | 1.00x | tensor | 1,592.13 | 381.8 | 3,054.1 | link_latency | 6.93x | 6.93x | 99.06x | 6.93x |
| DeepSeek-V4-Pro-0813 | 8 | smallest silicon | DSV4-Pro/ROM-N5-native-HBMKV-array-hybrid-x158 | 128,770 | 727.8 | 14,555.0 | compute | DSV4-Pro/b200_sxm-x80-tensor | 128,000 | 1.01x | tensor | 1,584.49 | 378.2 | 3,025.2 | link_latency | 1.92x | 4.81x | 25.54x | 1.92x |
| DeepSeek-V4-Pro-0813 | 16 | fastest | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3 | 138,675 | 2,619.5 | 41,912.2 | link_latency | DSV4-Pro/b200_sxm-x87-tensor | 139,200 | 1.00x | tensor | 2,396.13 | 262.6 | 4,201.6 | link_latency | 9.98x | 9.98x | 98.05x | 9.98x |
| DeepSeek-V4-Pro-0813 | 16 | smallest silicon | DSV4-Pro/ROM-N5-native-HBMKV-array-hybrid-x158 | 128,770 | 727.8 | 14,555.0 | compute | DSV4-Pro/b200_sxm-x80-tensor | 128,000 | 1.01x | tensor | 2,380.87 | 260.1 | 4,162.0 | link_latency | 2.80x | 3.50x | 25.54x | 2.80x |
| DeepSeek-V4-Pro-0813 | 32 | fastest | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,364.4 | 75,662.3 | link_latency | DSV4-Pro/b200_sxm-x116-tensor | 185,600 | 1.00x | tensor | 4,085.55 | 172.7 | 5,527.9 | link_latency | 13.69x | 13.69x | 111.35x | 13.69x |
| DeepSeek-V4-Pro-0813 | 32 | smallest silicon | DSV4-Pro/ROM-N5-native-HBMKV-array-hybrid-x158 | 128,770 | 502.7 | 16,087.2 | compute | DSV4-Pro/b200_sxm-x80-tensor | 128,000 | 1.01x | tensor | 3,973.62 | 166.7 | 5,333.2 | link_latency | 3.02x | 3.02x | 17.64x | 3.02x |
| DeepSeek-V4-Pro-0813 | 64 | fastest | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x4 | 184,900 | 2,351.7 | 150,507.7 | link_latency | DSV4-Pro/b200_sxm-x116-tensor | 185,600 | 1.00x | tensor | 7,382.99 | 104.0 | 6,653.2 | link_latency | 22.62x | 22.62x | 110.75x | 22.62x |
| DeepSeek-V4-Pro-0813 | 64 | smallest silicon | DSV4-Pro/ROM-N5-native-HBMKV-array-hybrid-x158 | 128,770 | 275.5 | 17,634.0 | compute | DSV4-Pro/b200_sxm-x80-hybrid | 128,000 | 1.01x | hybrid | 360.23 | 102.5 | 6,561.2 | weight_read | 2.69x | 2.69x | 9.67x | 2.69x |
| DeepSeek-V4-Pro-0813 | 256 | fastest | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x12-romfill | 554,700 | 1,991.3 | 509,783.8 | link_latency | DSV4-Pro/b200_sxm-x347-hybrid | 555,200 | 1.00x | hybrid | 481.50 | 36.4 | 9,313.7 | weight_read | 54.73x | 54.73x | 245.82x | 54.73x |
| DeepSeek-V4-Pro-0813 | 256 | smallest silicon | DSV4-Pro/ROM-N5-native-HBMKV-array-pipeline-x158 | 128,770 | 76.4 | 19,562.1 | compute | DSV4-Pro/b200_sxm-x80-hybrid | 128,000 | 1.01x | hybrid | 507.72 | 53.7 | 13,745.2 | weight_read | 1.42x | 1.42x | 4.31x | 1.42x |
...
|---|---:|---:|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 7 | 11,200 | 297.80 | 297.80 | 624.6 | 624.6 |
| DeepSeek-V4-Pro-0813 | 29 | 46,400 | 871.93 | 298.43 | 669.0 | 1,085.4 |
| DeepSeek-V4-Pro-0813 | 58 | 92,800 | 885.04 | 298.53 | 725.6 | 1,263.1 |
| DeepSeek-V4-Pro-0813 | 74 | 118,400 | 887.67 | 846.34 | 740.2 | 763.6 |
| DeepSeek-V4-Pro-0813 | 75 | 120,000 | 887.67 | 846.34 | 741.0 | 764.4 |
| DeepSeek-V4-Pro-0813 | 80 | 128,000 | 887.67 | 846.34 | 744.8 | 768.4 |
| DeepSeek-V4-Pro-0813 | 82 | 131,200 | 888.62 | 846.34 | 745.6 | 769.9 |
| DeepSeek-V4-Pro-0813 | 87 | 139,200 | 888.62 | 846.34 | 748.9 | 773.4 |
| DeepSeek-V4-Pro-0813 | 91 | 145,600 | 889.42 | 846.34 | 750.8 | 775.9 |
| DeepSeek-V4-Pro-0813 | 98 | 156,800 | 890.09 | 846.34 | 754.1 | 779.8 |
| DeepSeek-V4-Pro-0813 | 110 | 176,000 | 890.67 | 846.34 | 759.1 | 785.5 |
| DeepSeek-V4-Pro-0813 | 116 | 185,600 | 891.16 | 846.34 | 761.1 | 788.0 |
| DeepSeek-V4-Pro-0813 | 118 | 188,800 | 891.16 | 846.34 | 761.8 | 788.7 |
| DeepSeek-V4-Pro-0813 | 146 | 233,600 | 892.64 | 863.83 | 769.1 | 786.5 |
| DeepSeek-V4-Pro-0813 | 149 | 238,400 | 892.64 | 863.83 | 769.8 | 787.2 |
| DeepSeek-V4-Pro-0813 | 157 | 251,200 | 892.91 | 863.83 | 771.3 | 789.0 |
| DeepSeek-V4-Pro-0813 | 158 | 252,800 | 892.91 | 863.83 | 771.5 | 789.3 |
...
|---|---:|---:|---:|---:|---:|---|---:|---:|---|
| DeepSeek-V4-Pro-0813 | 7 | 11,200 | 110.8 | 624.6 | — | tensor | 297.80 | 18.6% | weight_read |
| DeepSeek-V4-Pro-0813 | 29 | 46,400 | 56.8 | 669.0 | 364.5 | tensor | 871.93 | 58.3% | link_latency |
| DeepSeek-V4-Pro-0813 | 58 | 92,800 | 36.1 | 725.6 | 241.8 | tensor | 885.04 | 64.2% | link_latency |
| DeepSeek-V4-Pro-0813 | 74 | 118,400 | 30.2 | 740.2 | 208.6 | tensor | 887.67 | 65.7% | link_latency |
| DeepSeek-V4-Pro-0813 | 75 | 120,000 | 29.9 | 741.0 | 209.3 | tensor | 887.67 | 65.8% | link_latency |
| DeepSeek-V4-Pro-0813 | 80 | 128,000 | 28.5 | 744.8 | 212.3 | tensor | 887.67 | 66.1% | link_latency |
| DeepSeek-V4-Pro-0813 | 82 | 131,200 | 28.0 | 745.6 | 195.2 | tensor | 888.62 | 66.3% | link_latency |
| DeepSeek-V4-Pro-0813 | 87 | 139,200 | 26.7 | 748.9 | 197.7 | tensor | 888.62 | 66.5% | link_latency |
| DeepSeek-V4-Pro-0813 | 91 | 145,600 | 25.8 | 750.8 | 183.8 | tensor | 889.42 | 66.8% | link_latency |
| DeepSeek-V4-Pro-0813 | 98 | 156,800 | 24.3 | 754.1 | 172.9 | tensor | 890.09 | 67.1% | link_latency |
| DeepSeek-V4-Pro-0813 | 110 | 176,000 | 22.2 | 759.1 | 164.7 | tensor | 890.67 | 67.6% | link_latency |
| DeepSeek-V4-Pro-0813 | 116 | 185,600 | 21.2 | 761.1 | 155.6 | tensor | 891.16 | 67.8% | link_latency |
| DeepSeek-V4-Pro-0813 | 118 | 188,800 | 20.9 | 761.8 | 156.1 | tensor | 891.16 | 67.9% | link_latency |
| DeepSeek-V4-Pro-0813 | 146 | 233,600 | 17.5 | 769.1 | 128.7 | tensor | 892.64 | 68.6% | link_latency |
| DeepSeek-V4-Pro-0813 | 149 | 238,400 | 17.2 | 769.8 | 129.1 | tensor | 892.64 | 68.7% | link_latency |
| DeepSeek-V4-Pro-0813 | 157 | 251,200 | 16.5 | 771.3 | 123.8 | tensor | 892.91 | 68.9% | link_latency |
| DeepSeek-V4-Pro-0813 | 158 | 252,800 | 16.4 | 771.5 | 123.9 | tensor | 892.91 | 68.9% | link_latency |
...
| DSV4-Pro/ROM-N5-native-HBMKV-array-pipeline-x160 | DeepSeek-V4-Pro-0813 | 160 | pipeline | nvlink5 | infiniband_ndr | 60 | 80.66 us | 1,239.8 tok/s | 12,397.5 tok/s | 53 x point_to_point span 2 on nvlink5 (traversals 1.0) = 64.44 us; 7 x point_to_point span 2 on infiniband_ndr (traversals 1.0) = 16.22 us |
...
| DSV4-Pro/ROM-N5-native-HBMKV-array-hybrid-x160 | DeepSeek-V4-Pro-0813 | 160 | hybrid | nvlink5 | infiniband_ndr | 141 | 341.92 us | 292.5 tok/s | 2,924.7 tok/s | 122 x all_reduce span 8 on nvlink5 (traversals 2.0) = 297.90 us; 19 x point_to_point span 2 on infiniband_ndr (traversals 1.0) = 44.02 us |
...
| DSV4-Pro/b200_sxm-x7-pipeline | DeepSeek-V4-Pro-0813 | 7 | pipeline | nvlink5 | infiniband_ndr | 6 | 7.30 us | 13,706.9 tok/s | 137,069.4 tok/s | 6 x point_to_point span 2 on nvlink5 (traversals 1.0) = 7.30 us |
| DSV4-Pro/b200_sxm-x7-tensor | DeepSeek-V4-Pro-0813 | 7 | tensor | nvlink5 | infiniband_ndr | 122 | 297.80 us | 335.8 tok/s | 3,358.0 tok/s | 122 x all_reduce span 7 on nvlink5 (traversals 2.0) = 297.80 us |
...
| DSV4-Pro/b200_sxm-x158-pipeline | DeepSeek-V4-Pro-0813 | 158 | pipeline | nvlink5 | infiniband_ndr | 60 | 80.66 us | 1,239.8 tok/s | 12,397.5 tok/s | 53 x point_to_point span 2 on nvlink5 (traversals 1.0) = 64.44 us; 7 x point_to_point span 2 on infiniband_ndr (traversals 1.0) = 16.22 us |
| DSV4-Pro/b200_sxm-x158-tensor | DeepSeek-V4-Pro-0813 | 158 | tensor | nvlink5 | infiniband_ndr | 244 | 892.91 us | 112.0 tok/s | 1,119.9 tok/s | 122 x all_reduce span 8 on nvlink5 (traversals 2.0) = 297.90 us; 122 x all_reduce span 20 on infiniband_ndr (traversals 2.0) = 595.01 us |
| DSV4-Pro/b200_sxm-x158-hybrid | DeepSeek-V4-Pro-0813 | 158 | hybrid | nvlink5 | infiniband_ndr | 141 | 341.92 us | 292.5 tok/s | 2,924.7 tok/s | 122 x all_reduce span 8 on nvlink5 (traversals 2.0) = 297.90 us; 19 x point_to_point span 2 on infiniband_ndr (traversals 1.0) = 44.02 us |
...
|---|---:|---|---|---|---:|---:|---:|---:|---:|---:|---|
| DeepSeek-V4-Pro-0813 | 1 | wafer | wafer | DSV4-Pro/ROM-N5-native-SRAMKV-wafer-hybrid-x3 | 138,675 | 2,648.8 | 0.019 | 1,035.8 (118,990) | 2,648.8 (138,675) | 2.56x | link_latency |
| DeepSeek-V4-Pro-0813 | 2 | wafer | wafer | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3 | 138,675 | 2,648.8 | 0.019 | 923.1 (130,400) | 2,648.8 (138,675) | 2.87x | link_latency |
| DeepSeek-V4-Pro-0813 | 4 | wafer | wafer | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3 | 138,675 | 2,648.3 | 0.019 | 888.6 (130,400) | 2,648.3 (138,675) | 2.98x | link_latency |
| DeepSeek-V4-Pro-0813 | 8 | wafer | wafer | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3 | 138,675 | 2,646.5 | 0.019 | 888.6 (130,400) | 2,646.5 (138,675) | 2.98x | link_latency |
| DeepSeek-V4-Pro-0813 | 16 | wafer | wafer | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3 | 138,675 | 2,619.5 | 0.019 | 888.6 (130,400) | 2,619.5 (138,675) | 2.95x | link_latency |
...
| DeepSeek-V4-Pro-0813 | 256 | wafer | wafer | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x12-romfill | 554,700 | 1,991.3 | 0.004 | 627.5 (185,005) | 1,991.3 (554,700) | 3.17x | link_latency |
...
| DeepSeek-V4-Pro-0813 | 16 | sram | 41,912.2 | 26,053.1 | 28,943.2 | 1.61x | 1.11x | link_latency | weight_read | link_latency |
...
| DeepSeek-V4-Pro-0813 | 256 | sram | 465,856.6 | 26,053.1 | 209,544.8 | 17.88x | 8.04x | link_latency | weight_read | weight_read |
...
| DeepSeek-V4-Pro-0813 | 256 | rom | 509,783.8 | 29,915.9 | 232,276.8 | 17.04x | 7.76x | link_latency | weight_read | weight_read |
...
| DeepSeek-V4-Pro-0813 | 16 | batched | sram | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x3 | 138,675 | 1.00 | 1.00 | 41,912.2 | 0.302 | link_latency | 1.00x |
| DeepSeek-V4-Pro-0813 | 16 | batched | rom | DSV4-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x12-romfill | 554,700 | 2.73 | 1.00 | 71,184.8 | 0.128 | weight_read | 1.70x |
| DeepSeek-V4-Pro-0813 | 16 | per_stream | sram | DSV4-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x6-perstream | 277,350 | 1.00 | 1.00 | 26,053.1 | 0.094 | weight_read | 0.62x |
...
| DeepSeek-V4-Pro-0813 | 16 | per_region | sram | DSV4-Pro/ROM-N5-native-SRAMKV-wafer-hybrid-x6-perregion | 277,350 | 1.00 | 1.19 | 28,943.2 | 0.104 | link_latency | 0.69x |
| DeepSeek-V4-Pro-0813 | 16 | per_region | rom | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x6-perregion-romfill | 277,350 | 1.15 | 1.19 | 30,927.7 | 0.112 | link_latency | 0.74x |
...
| DeepSeek-V4-Pro-0813 | 64 | per_stream | sram | DSV4-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x6-perstream | 277,350 | 1.00 | 1.00 | 26,053.1 | 0.094 | weight_read | 0.17x |
...
| DeepSeek-V4-Pro-0813 | 256 | batched | sram | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x6 | 277,350 | 1.00 | 1.00 | 465,856.6 | 1.680 | link_latency | 1.00x |
| DeepSeek-V4-Pro-0813 | 256 | batched | rom | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x12-romfill | 554,700 | 2.73 | 1.00 | 509,783.8 | 0.919 | link_latency | 1.09x |
| DeepSeek-V4-Pro-0813 | 256 | per_stream | sram | DSV4-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x6-perstream | 277,350 | 1.00 | 1.00 | 26,053.1 | 0.094 | weight_read | 0.06x |
...
| DeepSeek-V4-Pro-0813 | 256 | per_region | sram | DSV4-Pro/ROM-N5-native-SRAMKV-wafer-hybrid-x6-perregion | 277,350 | 1.00 | 4.02 | 209,544.8 | 0.756 | weight_read | 0.45x |
| DeepSeek-V4-Pro-0813 | 256 | per_region | rom | DSV4-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x6-perregion-romfill | 277,350 | 1.15 | 4.02 | 232,276.8 | 0.837 | weight_read | 0.50x |
...
|---|---:|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 1 | 7 | 4.22 | 2.86 | 1.47x |
| DeepSeek-V4-Pro-0813 | 2 | 7 | 4.22 | 2.86 | 1.47x |
| DeepSeek-V4-Pro-0813 | 4 | 7 | 4.22 | 2.86 | 1.47x |
| DeepSeek-V4-Pro-0813 | 8 | 7 | 4.56 | 2.98 | 1.53x |
| DeepSeek-V4-Pro-0813 | 16 | 7 | 6.14 | 3.59 | 1.71x |
| DeepSeek-V4-Pro-0813 | 32 | 7 | 6.89 | 4.19 | 1.64x |
| DeepSeek-V4-Pro-0813 | 64 | 7 | 7.00 | 4.74 | 1.48x |
| DeepSeek-V4-Pro-0813 | 256 | 7 | 7.00 | 5.55 | 1.26x |
...
| DeepSeek-V4-Pro-0813 | 1 | 158 | 5.91 | 5.52 | 1.07x |
| DeepSeek-V4-Pro-0813 | 2 | 158 | 5.91 | 5.52 | 1.07x |
| DeepSeek-V4-Pro-0813 | 4 | 158 | 5.91 | 5.52 | 1.07x |
| DeepSeek-V4-Pro-0813 | 8 | 158 | 5.91 | 5.52 | 1.07x |
| DeepSeek-V4-Pro-0813 | 16 | 158 | 5.91 | 5.52 | 1.07x |
| DeepSeek-V4-Pro-0813 | 32 | 158 | 5.91 | 5.52 | 1.07x |
| DeepSeek-V4-Pro-0813 | 64 | 158 | 5.91 | 5.52 | 1.07x |
| DeepSeek-V4-Pro-0813 | 256 | 158 | 9.41 | 7.86 | 1.20x |
...
|---|---:|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 1 | 293 | 15.73% | 142.94 | 3.10 |
| DeepSeek-V4-Pro-0813 | 2 | 293 | 15.73% | 142.94 | 3.10 |
| DeepSeek-V4-Pro-0813 | 4 | 293 | 15.73% | 142.94 | 3.10 |
| DeepSeek-V4-Pro-0813 | 8 | 6 | 0.34% | 3.58 | 3.10 |
| DeepSeek-V4-Pro-0813 | 16 | 6 | 0.34% | 3.58 | 3.10 |
| DeepSeek-V4-Pro-0813 | 32 | 6 | 0.34% | 3.58 | 3.10 |
| DeepSeek-V4-Pro-0813 | 64 | 6 | 0.34% | 3.58 | 3.10 |
| DeepSeek-V4-Pro-0813 | 256 | 6 | 0.34% | 3.58 | 3.10 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| DeepSeek-V4-Pro-0813 | 1 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 123.3 | 19,474.1 |
| DeepSeek-V4-Pro-0813 | 2 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 123.3 | 19,474.1 |
| DeepSeek-V4-Pro-0813 | 4 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 123.3 | 19,474.1 |
| DeepSeek-V4-Pro-0813 | 8 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 123.3 | 19,474.1 |
| DeepSeek-V4-Pro-0813 | 16 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 123.3 | 19,474.1 |
| DeepSeek-V4-Pro-0813 | 32 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 123.3 | 19,474.1 |
| DeepSeek-V4-Pro-0813 | 64 | 1.56% | 39.7 GB | 4.44% | 1,150.91 TB/s | 25,902.15 TB/s | 123.3 | 19,474.1 |
| DeepSeek-V4-Pro-0813 | 256 | 2.52% | 47.5 GB | 5.32% | 1,379.14 TB/s | 25,902.15 TB/s | 76.4 | 19,562.1 |
