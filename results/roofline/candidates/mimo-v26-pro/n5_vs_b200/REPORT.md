...
8. **Sparse MoE buys aggregate throughput on a ROM machine, not latency.** MiMo-V2.6-Pro engages 100.0% of its ROM array at batch 1 and 100.0% at batch 4096, while the weight-read time is identical at both. What the machine delivers rises from 59 to 165,105 tok/s, and its rate with every slot occupied from 164,695 to 165,105. The second rises far less than the first because the batch-1 figure is already a full-machine number -- this design has 2,780 slots -- so most of what batching adds there is coverage rather than occupancy. An unselected expert's read ports cannot be borrowed, so its idle bandwidth is only recovered by giving the sweep more users.
...
13. **A third machine sits between them, and for a sparse model it recovers part of what compute-in-ROM gives up -- less than the mean-region arithmetic used to say.** Give each expert region its own activation port and two tokens selecting disjoint experts drive disjoint regions at the same time; only the tokens landing on one region serialise, and the sweep waits for the BUSIEST region rather than the average engaged one. The largest gain over a global broadcast is 6.29x, on MiMo-V2.6-Pro at batch 4096, where the busiest region carries 3.17x the load of the mean engaged one. It is not free ground: per-region still loses to the amortising ROM-plus-MAC machine at 20 of 20 operating points. A dense model has one region, so it gains nothing -- the disjointness is what sparsity buys.
...
- **4,394.8 tok/s per user** (0.23 ms/token), binding on `layer_fixed_latency`
- **47.5 tok/s per 1,000 mm2** -- the quantity the rule maximises
- 4,395 tok/s aggregate with every slot full, over 1 resident session (fill limited by `kv_capacity`)
- 5,715 W at 0.062 W/mm2, 1,300.3 mJ/token, thermal scale 1.000
...
| user tok/s | 4,394.8 | 497.5 | 8.83x |
| aggregate tok/s | 4,395 | 498 | 0.69x |
| resident sessions | 1 | 859 | -- |
| J/token | 1.3003 | 46.1271 | 35.5x |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| before -- smallest within 5% of peak rate | `ROM-N5-native-SRAMKV-wafer-hybrid-x2` | 92,450 | 4,394.8 | 47.5 | 1 | 8.83x |
| rank on per-user rate alone | `ROM-N5-native-SRAMKV-wafer-hybrid-x3` | 138,675 | 4,559.2 | 32.9 | 1 | 9.38x |
| smallest feasible machine | `ROM-N5-native-SRAMKV-array-hw-hybrid-x113` | 92,095 | 2,691.2 | 29.2 | 1 | 5.41x |
| **after -- this report's rule** | `ROM-N5-native-SRAMKV-wafer-hybrid-x2` | 92,450 | 4,394.8 | 47.5 | 1 | 8.83x |

**The walk, rung by rung.** The number in the `marginal` column is what the next slab of silicon returns; the number in `incumbent average` is what the silicon already bought returns. The walk stops the first time the former is not larger.

| design | mm2 | user tok/s | tok/s per 1,000 mm2 | marginal | incumbent average | verdict |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| `ROM-N5-native-SRAMKV-wafer-hybrid-x2` | 92,450 | 4,394.8 | 47.5 | -- | 47.5 | ACCEPT |
| `ROM-N5-native-SRAMKV-wafer-hybrid-x3` | 138,675 | 4,559.2 | 32.9 | 3.6 | 47.5 | stop |

**The frontier at batch 1, published in full.** Every design here is one that nothing else beats on both axes at once, so a reader with a latency target this report does not know about can read their own point off it. An honest curve beats a false single answer, and the rows above and below the recommendation are the ones that show what the rule is doing.

| design | mm2 | devices | user tok/s | aggregate tok/s | tok/s per 1,000 mm2 | resident sessions | binds on | W | mJ/token | iso-area GPU | ratio |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | --- | ---: |
| `ROM-N5-native-SRAMKV-wafer-hybrid-x2` **<-- recommended** | 92,450 | 2 | 4,394.8 | 4,395 | 47.5 | 1 | `layer_fixed_latency` | 5,715 | 1,300.3 | `b200_sxm-x58-nvl72-tensor` | 8.83x |
| `ROM-N5-native-SRAMKV-wafer-hybrid-x3` | 138,675 | 3 | 4,559.2 | 4,559 | 32.9 | 1 | `layer_fixed_latency` | 12,426 | 2,725.4 | `b200_sxm-x87-nvl72-hybrid` | 9.38x |
...
| wafer | 42 | densest | `ROM-N5-native-SRAMKV-wafer-hybrid-x2` | 92,450 | 4,394.8 | 47.5 | 1 |
| wafer | 42 | fastest | `ROM-N5-native-SRAMKV-wafer-hybrid-x3` | 138,675 | 4,559.2 | 32.9 | 1 |
| wafer | 42 | smallest | `ROM-N5-native-SRAMKV-wafer-hybrid-x2` | 92,450 | 4,394.8 | 47.5 | 1 |
...
| 1 | wafer | `ROM-N5-native-SRAMKV-wafer-hybrid-x3` | 138,675 | 4,559.2 | 4,559 | 1 | 12,426 | 2,725.4 | `layer_fixed_latency` | `b200_sxm-x87-nvl72-hybrid` | 485.8 | 1,316 | 68,027.2 | 0.996 | 9.38x | 25.0x |
...
| 1 | wafer reference | `ROM-N5-native-SRAMKV-wafer-hybrid-x3` | 138,675 | 4,559.2 | -- | 1 | -- | 2,725.4 | -- | -- | -- | -- | -- | 0.999 | 1.53x wafer/array | -- |
| 2 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x49` | 2,265,025 | 3,102.5 | 40,332 | 4,150 | 371,213 | 53,761.8 | `layer_fixed_latency` | `b200_sxm-x1416-nvl72-hybrid` | 492.3 | 22,260 | 509,282.9 | 1.000 | 6.30x | 9.5x |
| 4 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x49` | 2,265,025 | 3,102.5 | 40,332 | 4,150 | 371,213 | 27,432.1 | `layer_fixed_latency` | `b200_sxm-x1416-nvl72-hybrid` | 492.3 | 22,260 | 257,278.3 | 1.000 | 6.30x | 9.4x |
| 8 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x49` | 2,265,025 | 3,102.5 | 40,332 | 4,150 | 371,213 | 14,267.2 | `layer_fixed_latency` | `b200_sxm-x1416-nvl72-hybrid` | 492.3 | 22,260 | 131,276.1 | 1.000 | 6.30x | 9.2x |
| 16 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x49` | 2,265,025 | 2,810.1 | 44,962 | 4,150 | 376,242 | 8,368.1 | `layer_fixed_latency` | `b200_sxm-x1416-nvl72-hybrid` | 492.3 | 22,260 | 68,274.9 | 1.000 | 5.71x | 8.2x |
| 32 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x49` | 2,265,025 | 2,366.5 | 75,729 | 4,150 | 410,088 | 5,415.2 | `kv_read` | `b200_sxm-x1416-nvl72-hybrid` | 483.9 | 22,260 | 36,196.6 | 1.000 | 4.89x | 6.7x |
| 64 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x49` | 2,265,025 | 1,748.5 | 111,903 | 4,150 | 449,881 | 4,020.3 | `kv_read` | `b200_sxm-x1416-nvl72-hybrid` | 463.2 | 22,260 | 19,945.1 | 1.000 | 3.78x | 5.0x |
| 256 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x49` | 2,265,025 | 584.9 | 149,736 | 4,150 | 491,395 | 3,281.8 | `kv_read` | `b200_sxm-x1416-nvl72-hybrid` | 371.7 | 22,260 | 7,617.1 | 1.000 | 1.57x | 2.3x |
| 1024 | wafer | `ROM-N5-native-HBMKV-wafer-hybrid-x49` | 2,265,025 | 158.4 | 162,209 | 4,150 | 505,108 | 3,113.9 | `kv_read` | `b200_sxm-x1416-nvl72-hybrid` | 221.5 | 22,260 | 4,104.2 | 1.000 | 0.72x | 1.3x |
| 4096 | wafer | `ROM-N5-native-HBMKV-wafer-pipeline-x49` | 2,265,025 | 40.3 | 165,105 | 4,150 | 508,292 | 3,078.6 | `kv_read` | `b200_sxm-x1416-nvl72-hybrid` | 99.0 | 22,260 | 2,917.9 | 1.000 | 0.41x | 0.9x |
...
|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|
| MiMo-V2.6-Pro | `ROM-N5-native-SRAMKV-wafer-hybrid-x2` | 1 | 57 on `rom_wafer_express` | 3.00 | centre_mesh, one_shot | 163.96 | 30.98 | 40.77 | 34.44 | 4,394.8 |
...
|---|---:|---:|---|---:|---:|---|---|---:|---:|---|---:|
| MiMo-V2.6-Pro | 1 | 92,450 | `MiMo-V2.6-Pro/ROM-N5-native-SRAMKV-wafer-hybrid-x2` | 1.300324 | 5,714.6 | layer_fixed_latency | `MiMo-V2.6-Pro/b200_sxm-x58-nvl72-tensor` | 46.127148 | 22,949.3 | layer_fixed_latency | 35.47x |
| MiMo-V2.6-Pro | 2 | 2,265,025 | `MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49` | 53.761842 | 371,213.4 | layer_fixed_latency | `MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid` | 509.282915 | 548,146.1 | layer_fixed_latency | 9.47x |
| MiMo-V2.6-Pro | 4 | 2,265,025 | `MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49` | 27.432113 | 371,213.4 | layer_fixed_latency | `MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid` | 257.278344 | 548,146.1 | layer_fixed_latency | 9.38x |
| MiMo-V2.6-Pro | 8 | 2,265,025 | `MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49` | 14.267248 | 371,213.4 | layer_fixed_latency | `MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid` | 131.276058 | 548,146.1 | layer_fixed_latency | 9.20x |
| MiMo-V2.6-Pro | 16 | 2,265,025 | `MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49` | 8.368052 | 376,242.5 | layer_fixed_latency | `MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid` | 68.274915 | 548,146.1 | layer_fixed_latency | 8.16x |
| MiMo-V2.6-Pro | 32 | 2,265,025 | `MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49` | 5.415210 | 410,087.9 | kv_read | `MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid` | 36.196619 | 560,521.0 | layer_fixed_latency | 6.68x |
| MiMo-V2.6-Pro | 64 | 2,265,025 | `MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49` | 4.020260 | 449,881.0 | kv_read | `MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid` | 19.945097 | 591,206.8 | layer_fixed_latency | 4.96x |
| MiMo-V2.6-Pro | 256 | 2,265,025 | `MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49` | 3.281751 | 491,394.6 | kv_read | `MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid` | 7.617097 | 724,715.6 | layer_fixed_latency | 2.32x |
| MiMo-V2.6-Pro | 1024 | 2,265,025 | `MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49` | 3.113941 | 505,108.2 | kv_read | `MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid` | 4.104200 | 930,864.4 | layer_fixed_latency | 1.32x |
| MiMo-V2.6-Pro | 4096 | 2,265,025 | `MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49` | 3.078609 | 508,292.4 | kv_read | `MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid` | 2.917911 | 1,183,651.1 | kv_read | 0.95x |
...
|---|---:|---:|---:|---|---:|---|---:|---:|---|---:|---|---:|---:|---:|---:|
| MiMo-V2.6-Pro | 2 | 92,450 | 4,733.9 | wafer-hybrid | 4,394.8 | wafer-hybrid | 1.08x | 634.1 | pipeline | 497.5 | tensor | 1.27x | 7.47x | 8.83x | 1.18x |
| MiMo-V2.6-Pro | 3 | 138,675 | 5,499.8 | wafer-pipeline | 4,559.2 | wafer-hybrid | 1.21x | 645.8 | pipeline | 485.8 | hybrid | 1.33x | 8.52x | 9.38x | 1.10x |
| MiMo-V2.6-Pro | 4 | 184,900 | 5,499.8 | wafer-pipeline | 4,392.1 | wafer-hybrid | 1.25x | 655.1 | pipeline | 496.5 | hybrid | 1.32x | 8.40x | 8.85x | 1.05x |
| MiMo-V2.6-Pro | 6 | 277,350 | 5,499.8 | wafer-pipeline | 4,085.1 | wafer-hybrid | 1.35x | 664.5 | pipeline | 495.7 | hybrid | 1.34x | 8.28x | 8.24x | 1.00x |
| MiMo-V2.6-Pro | 8 | 369,800 | 5,695.1 | wafer-pipeline | 3,801.6 | wafer-hybrid | 1.50x | 669.5 | pipeline | 495.2 | hybrid | 1.35x | 8.51x | 7.68x | 0.90x |
| MiMo-V2.6-Pro | 12 | 554,700 | 5,695.1 | wafer-pipeline | 3,522.7 | wafer-hybrid | 1.62x | 674.5 | pipeline | 500.1 | hybrid | 1.35x | 8.44x | 7.04x | 0.83x |

**Did the error cancel in the ratio?** If it had, `Ratio change` would be 1.00x on every row. It runs from 0.83x to 1.18x across this ladder. It does not cancel, for the reason the two families reach equal area at very different device counts and therefore at very different slot counts, and because the correction changes which topology each side picks -- a change that lands on whichever side was relying on depth.
...
|---|---:|---|---|---:|---:|---:|---|---|---:|---:|---|---:|---:|---:|---|---:|---:|---:|---:|
| MiMo-V2.6-Pro | 1 | fastest | MiMo-V2.6-Pro/ROM-N5-native-SRAMKV-wafer-hybrid-x3 | 138,675 | 4,559.2 | 4,559.2 | layer_fixed_latency | MiMo-V2.6-Pro/b200_sxm-x87-nvl72-hybrid | 139,200 | 1.00x | hybrid | 515.95 | 485.8 | 971.7 | layer_fixed_latency | 9.38x | 0.48x | 41.57x | 9.38x |
...
| MiMo-V2.6-Pro | 2 | fastest | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 3,102.5 | 40,332.5 | layer_fixed_latency | MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid | 2,265,600 | 1.00x | hybrid | 556.93 | 492.3 | 9,845.5 | layer_fixed_latency | 6.30x | 0.26x | 28.29x | 6.30x |
| MiMo-V2.6-Pro | 4 | fastest | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 3,102.5 | 40,332.5 | layer_fixed_latency | MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid | 2,265,600 | 1.00x | hybrid | 556.93 | 492.3 | 9,845.5 | layer_fixed_latency | 6.30x | 0.26x | 28.29x | 6.30x |
| MiMo-V2.6-Pro | 8 | fastest | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 3,102.5 | 40,332.5 | layer_fixed_latency | MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid | 2,265,600 | 1.00x | hybrid | 556.93 | 492.3 | 9,845.5 | layer_fixed_latency | 6.30x | 0.26x | 28.29x | 6.30x |
| MiMo-V2.6-Pro | 16 | fastest | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 2,810.1 | 44,961.8 | layer_fixed_latency | MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid | 2,265,600 | 1.00x | hybrid | 556.93 | 492.3 | 9,845.5 | layer_fixed_latency | 5.71x | 0.29x | 25.62x | 5.71x |
| MiMo-V2.6-Pro | 32 | fastest | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 2,366.5 | 75,728.9 | kv_read | MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid | 2,265,600 | 1.00x | hybrid | 564.32 | 483.9 | 15,485.5 | layer_fixed_latency | 4.89x | 0.49x | 21.58x | 4.89x |
| MiMo-V2.6-Pro | 64 | fastest | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 1,748.5 | 111,903.4 | kv_read | MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid | 2,265,600 | 1.00x | hybrid | 584.04 | 463.2 | 29,641.7 | layer_fixed_latency | 3.78x | 0.72x | 15.94x | 3.78x |
| MiMo-V2.6-Pro | 256 | fastest | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 584.9 | 149,735.5 | kv_read | MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid | 2,265,600 | 1.00x | hybrid | 702.37 | 371.7 | 95,143.3 | layer_fixed_latency | 1.57x | 0.96x | 5.33x | 1.57x |
| MiMo-V2.6-Pro | 1024 | fastest | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 158.4 | 162,208.7 | kv_read | MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid | 2,265,600 | 1.00x | hybrid | 1,175.66 | 221.5 | 226,807.7 | layer_fixed_latency | 0.72x | 0.72x | 1.44x | 0.72x |
| MiMo-V2.6-Pro | 4096 | fastest | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 40.3 | 165,104.6 | kv_read | MiMo-V2.6-Pro/b200_sxm-x1416-nvl72-hybrid | 2,265,600 | 1.00x | hybrid | 1,781.16 | 99.0 | 405,650.2 | kv_read | 0.41x | 0.41x | 0.62x | 0.41x |
...
|---|---:|---|---|---|---:|---:|---:|---:|---:|---:|---|
| MiMo-V2.6-Pro | 1 | wafer | wafer | MiMo-V2.6-Pro/ROM-N5-native-SRAMKV-wafer-hybrid-x2 | 92,450 | 4,394.8 | 0.048 | 3,064.9 (114,100) | 4,394.8 (92,450) | 1.43x | layer_fixed_latency |
| MiMo-V2.6-Pro | 2 | wafer | wafer | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 3,102.5 | 0.001 | — (—) | 3,102.5 (2,265,025) | — | layer_fixed_latency |
| MiMo-V2.6-Pro | 4 | wafer | wafer | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 3,102.5 | 0.001 | — (—) | 3,102.5 (2,265,025) | — | layer_fixed_latency |
| MiMo-V2.6-Pro | 8 | wafer | wafer | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 3,102.5 | 0.001 | — (—) | 3,102.5 (2,265,025) | — | layer_fixed_latency |
| MiMo-V2.6-Pro | 16 | wafer | wafer | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 2,810.1 | 0.001 | — (—) | 2,810.1 (2,265,025) | — | layer_fixed_latency |
| MiMo-V2.6-Pro | 32 | wafer | wafer | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 2,366.5 | 0.001 | — (—) | 2,366.5 (2,265,025) | — | kv_read |
| MiMo-V2.6-Pro | 64 | wafer | wafer | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 1,748.5 | 0.001 | — (—) | 1,748.5 (2,265,025) | — | kv_read |
| MiMo-V2.6-Pro | 256 | wafer | wafer | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 584.9 | 0.000 | — (—) | 584.9 (2,265,025) | — | kv_read |
| MiMo-V2.6-Pro | 1024 | wafer | wafer | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49 | 2,265,025 | 158.4 | 0.000 | — (—) | 158.4 (2,265,025) | — | kv_read |
...
|---|---:|---|---:|---:|---:|---:|---:|---|---|---|
| MiMo-V2.6-Pro | 1 | sram | 164,694.6 | 26,077.3 | 26,077.3 | 6.32x | 1.00x | kv_read | weight_read | weight_read |
| MiMo-V2.6-Pro | 2 | sram | 164,694.6 | 26,077.3 | 26,077.3 | 6.32x | 1.00x | kv_read | weight_read | weight_read |
| MiMo-V2.6-Pro | 4 | sram | 164,694.6 | 26,077.3 | 26,077.3 | 6.32x | 1.00x | kv_read | weight_read | weight_read |
| MiMo-V2.6-Pro | 8 | sram | 164,694.6 | 26,077.3 | 26,077.3 | 6.32x | 1.00x | kv_read | weight_read | weight_read |
| MiMo-V2.6-Pro | 16 | sram | 164,694.6 | 26,077.3 | 26,077.3 | 6.32x | 1.00x | kv_read | weight_read | weight_read |
| MiMo-V2.6-Pro | 32 | sram | 164,694.6 | 26,077.3 | 35,946.5 | 6.32x | 1.38x | kv_read | weight_read | weight_read |
| MiMo-V2.6-Pro | 64 | sram | 164,694.6 | 26,077.3 | 53,455.5 | 6.32x | 2.05x | kv_read | weight_read | weight_read |
| MiMo-V2.6-Pro | 256 | sram | 164,694.6 | 26,077.3 | 122,446.7 | 6.32x | 4.70x | kv_read | weight_read | weight_read |
| MiMo-V2.6-Pro | 1024 | sram | 164,694.6 | 26,077.3 | 157,520.9 | 6.32x | 6.04x | kv_read | weight_read | kv_read |
| MiMo-V2.6-Pro | 4096 | sram | 165,104.6 | 26,087.5 | 164,135.6 | 6.33x | 6.29x | kv_read | weight_read | kv_read |
| MiMo-V2.6-Pro | 1 | rom | 164,658.1 | 164,585.1 | 164,585.1 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
| MiMo-V2.6-Pro | 2 | rom | 164,658.1 | 164,585.1 | 164,585.1 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
| MiMo-V2.6-Pro | 4 | rom | 164,658.1 | 164,585.1 | 164,585.1 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
| MiMo-V2.6-Pro | 8 | rom | 164,658.1 | 164,585.1 | 164,585.1 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
| MiMo-V2.6-Pro | 16 | rom | 164,658.1 | 164,585.1 | 164,585.1 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
| MiMo-V2.6-Pro | 32 | rom | 164,658.1 | 164,585.1 | 164,585.1 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
| MiMo-V2.6-Pro | 64 | rom | 164,658.1 | 164,585.1 | 164,585.1 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
| MiMo-V2.6-Pro | 256 | rom | 164,658.1 | 164,585.1 | 164,585.1 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
| MiMo-V2.6-Pro | 1024 | rom | 164,658.1 | 164,585.1 | 164,585.1 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
| MiMo-V2.6-Pro | 4096 | rom | 165,043.3 | 164,992.9 | 164,992.9 | 1.00x | 1.00x | kv_read | kv_read | kv_read |
...
|---|---:|---|---|---|---:|---:|---:|---:|---:|---|---:|
| MiMo-V2.6-Pro | 1 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 164,694.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 1 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 164,658.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 1 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 1 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 1 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 1 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 2 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 164,694.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 2 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 164,658.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 2 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 2 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 2 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 2 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 4 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 164,694.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 4 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 164,658.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 4 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 4 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 4 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 4 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 8 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 164,694.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 8 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 164,658.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 8 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 8 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 8 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 8 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 16 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 164,694.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 16 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 164,658.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 16 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 16 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 16 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 16 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 32 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 164,694.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 32 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 164,658.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 32 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 32 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 32 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49-perregion | 2,265,025 | 1.00 | 1.26 | 35,946.5 | 0.016 | weight_read | 0.22x |
| MiMo-V2.6-Pro | 32 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 64 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 164,694.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 64 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 164,658.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 64 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 64 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 64 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49-perregion | 2,265,025 | 1.00 | 1.82 | 53,455.5 | 0.024 | weight_read | 0.32x |
| MiMo-V2.6-Pro | 64 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 256 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 164,694.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 256 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 164,658.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 256 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 256 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 256 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49-perregion | 2,265,025 | 1.00 | 3.19 | 122,446.7 | 0.054 | weight_read | 0.74x |
| MiMo-V2.6-Pro | 256 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 1024 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 164,694.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 1024 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 164,658.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 1024 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.00 | 26,077.3 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 1024 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 1024 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49-perregion | 2,265,025 | 1.00 | 3.27 | 157,520.9 | 0.070 | kv_read | 0.96x |
| MiMo-V2.6-Pro | 1024 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.00 | 164,585.1 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 4096 | batched | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49 | 2,265,025 | 1.00 | 1.00 | 165,104.6 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 4096 | batched | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-romfill | 2,265,025 | 17.61 | 1.00 | 165,043.3 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 4096 | per_stream | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream | 2,265,025 | 1.00 | 1.47 | 26,087.5 | 0.012 | weight_read | 0.16x |
| MiMo-V2.6-Pro | 4096 | per_stream | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perstream-romfill | 2,265,025 | 59.18 | 1.47 | 164,992.9 | 0.073 | kv_read | 1.00x |
| MiMo-V2.6-Pro | 4096 | per_region | sram | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-hybrid-x49-perregion | 2,265,025 | 1.00 | 3.44 | 164,135.6 | 0.072 | kv_read | 0.99x |
| MiMo-V2.6-Pro | 4096 | per_region | rom | MiMo-V2.6-Pro/ROM-N5-native-HBMKV-wafer-pipeline-x49-perregion-romfill | 2,265,025 | 59.18 | 1.07 | 164,992.9 | 0.073 | kv_read | 1.00x |
...
| rom | MiMo-V2.6-Pro | 1 | 150.59 | 72.0% |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| MiMo-V2.6-Pro | 1 | 2.08% | 39.3 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 59.2 | 164,694.6 |
| MiMo-V2.6-Pro | 2 | 2.08% | 39.3 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 59.2 | 164,694.6 |
| MiMo-V2.6-Pro | 4 | 2.08% | 39.3 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 59.2 | 164,694.6 |
| MiMo-V2.6-Pro | 8 | 2.08% | 39.3 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 59.2 | 164,694.6 |
| MiMo-V2.6-Pro | 16 | 2.08% | 39.3 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 59.2 | 164,694.6 |
| MiMo-V2.6-Pro | 32 | 2.08% | 39.3 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 59.2 | 164,694.6 |
| MiMo-V2.6-Pro | 64 | 2.08% | 39.3 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 59.2 | 164,694.6 |
| MiMo-V2.6-Pro | 256 | 2.08% | 39.3 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 59.2 | 164,694.6 |
| MiMo-V2.6-Pro | 1024 | 2.08% | 39.3 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 59.2 | 164,694.6 |
| MiMo-V2.6-Pro | 4096 | 3.05% | 44.5 GB | 100.00% | 16,423.08 TB/s | 16,423.08 TB/s | 40.3 | 165,104.6 |
...
| rom | infeasible | 2120 |
| rom | kv_read | 101 |
| rom | layer_fixed_latency | 146 |
| rom | link_latency | 117 |
| rom | weight_read | 50 |
