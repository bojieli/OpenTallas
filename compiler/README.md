...
cost class, and implementation owner. Thirty-eight operator references—routed
...
normalization, final HC-head reduction, KV FP8 QDQ, indexer FP4 QDQ, indexer
Hadamard rotation,
...
implemented and unit-qualified; the other eight
