...
cost class, and implementation owner. Nineteen operator references—dense FP8
linear, weighted RMS normalization, unweighted BF16 head RMS normalization, KV
FP8 QDQ, indexer FP4 QDQ, indexer
Hadamard rotation, target-hidden HC capture, HC expansion, HC post-mixing, token
...
dispatch—are implemented and unit-qualified; the other 24 reference kinds and
