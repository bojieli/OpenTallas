...
cost class, and implementation owner. Twenty-one operator references—dense FP8
linear, index-head BF16 linear, binary32 router-score projection, weighted RMS
...
dispatch—are implemented and unit-qualified; the other 22 reference kinds and
