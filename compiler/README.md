...
cost class, and implementation owner. Twenty operator references—dense FP8
linear, index-head BF16 linear, weighted RMS normalization, unweighted BF16 head
RMS normalization, KV FP8 QDQ, indexer FP4 QDQ, indexer Hadamard rotation,
...
dispatch—are implemented and unit-qualified; the other 23 reference kinds and
