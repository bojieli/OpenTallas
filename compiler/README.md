...
cost class, and implementation owner. Fifteen operator references—dense FP8
linear, indexer FP4 QDQ, target-hidden HC capture, HC expansion, HC post-mixing,
...
dispatch—are implemented and unit-qualified; the other 28 reference kinds and
