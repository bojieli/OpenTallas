...
cost class, and implementation owner. Twenty-six operator references—dense FP8
linear, index-head BF16 linear, binary32 router-score, compressor, and
DSpark-confidence projections, learned sparse-index scoring, block-64 sparse
...
dispatch, and expert reduction—are implemented and unit-qualified; the other 17
reference kinds and all 43 service-engine/RTL kinds remain pending.
