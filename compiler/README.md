...
cost class, and implementation owner. Sixteen operator references—dense FP8
linear, KV FP8 QDQ, indexer FP4 QDQ, target-hidden HC capture, HC expansion, HC
post-mixing,
...
dispatch—are implemented and unit-qualified; the other 27 reference kinds and
