...
cost class, and implementation owner. Twelve operator references—dense FP8
...
top-k, and routed-weight normalization—are implemented and unit-qualified; the
other 31 reference kinds and all 43 service-engine/RTL kinds remain pending.
