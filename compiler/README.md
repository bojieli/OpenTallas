...
cost class, and implementation owner. Twenty-five operator references—dense FP8
linear, index-head BF16 linear, binary32 router-score, compressor, and
DSpark-confidence projections, learned sparse-index scoring, weighted RMS
...
dispatch, and expert reduction—are implemented and unit-qualified; the other 18
