`timescale 1ns/1ps
// Registered wrapper round the combinational BF16 adder, so place-and-route
// measures the adder's own flop-to-flop delay and nothing else.
module ot_probe_bf16_add (
  ...
  ot_bf16_add_rne u (.left_code(l_q), .right_code(r_q),
