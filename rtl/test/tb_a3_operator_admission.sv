...
module tb_a3_operator_admission;
    ...
    ot_a3_engine_issue_bridge dut (
        ...
        .cfg_place_object_0(cfg_map_object[0]),
        .cfg_place_base_0(cfg_map_base[0]),
        .cfg_place_object_1(cfg_map_object[1]),
        .cfg_place_base_1(cfg_map_base[1]),
        .cfg_place_object_2(cfg_map_object[2]),
        .cfg_place_base_2(cfg_map_base[2]),
        .cfg_place_object_3(cfg_map_object[3]),
        .cfg_place_base_3(cfg_map_base[3]),
        .cfg_place_object_4(cfg_map_object[4]),
        .cfg_place_base_4(cfg_map_base[4]),
        .cfg_place_object_5(cfg_map_object[5]),
        .cfg_place_base_5(cfg_map_base[5]),
        .cfg_place_object_6(cfg_map_object[6]),
