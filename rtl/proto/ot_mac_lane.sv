...
//
// Numerically qualified against runtime.reference.mac_tile by
// rtl/test/tb_mac_tile.sv.
// ---------------------------------------------------------------------------
module ot_mac_lane #(
    ...
    input  wire              a_zero,
    input  wire [15:0]       b,           // this lane's BF16 weight
