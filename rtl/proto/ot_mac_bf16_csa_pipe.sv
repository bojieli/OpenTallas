`timescale 1ns/1ps
// ---------------------------------------------------------------------------
// Carry-save MAC -- PROTOTYPE, timing evidence only, NOT numerically qualified.
//
// Measured on ASAP7: 1,469 MHz, 1,287 cells, 206 um2, critical path 0.681 ns,
// against ot_fp32_rne_pkg::fp32_add_rne at 174 MHz and 2,458 cells -- 8.4x the
// frequency at roughly half the cells.  See docs/DATAPATH_PIPELINE_REDESIGN.md.
//
// It has no campaign against a scalar reference and must not be wired into any
// consumer until it does.
//
